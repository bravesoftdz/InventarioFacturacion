...
type
  TfCuadres_Vendedores = class(TForm)
...
var
  fCuadres_Vendedores : TfCuadres_Vendedores;
  Buffer       : String = '';
  LstNCF       : String = '00';
...
procedure TfCuadres_Vendedores.FormCreate(Sender: TObject);
  Var
    I : Integer;
begin
...
procedure TfCuadres_Vendedores.FacturasCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  If modified Then
    Begin
...
procedure TfCuadres_Vendedores.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfCuadres_Vendedores.SalirExecute(Sender: TObject);
begin
  Close
end;

procedure TfCuadres_Vendedores.NuevoExecute(Sender: TObject);
begin
   Try
...
procedure TfCuadres_Vendedores.RemoveExecute(Sender: TObject);
begin
  If Modulo.tDetalles_Acuerdos.RecordCount > 0 Then Modulo.tDetalles_Acuerdos.Delete
end;

procedure TfCuadres_Vendedores.Remove_AllExecute(Sender: TObject);
begin
  Modulo.tDetalles_Acuerdos.First;
  While Not Modulo.tDetalles_Acuerdos.EOF Do Remove.Execute;
end;

procedure TfCuadres_Vendedores.GuardarExecute(Sender: TObject);
begin
...
procedure TfCuadres_Vendedores.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
Var
  Found : TWinControl;
begin
...
procedure TfCuadres_Vendedores.SerialPortTriggerAvail(CP: TObject; Count: Word);
var
  I : Word;
  C : Char;
  S : String;
...
procedure TfCuadres_Vendedores.grdFacturasRowChanged(Sender: TObject);
begin
...
procedure TfCuadres_Vendedores.AddExecute(Sender: TObject);
begin
...
procedure TfCuadres_Vendedores.Add_AllExecute(Sender: TObject);
begin
...
procedure TfCuadres_Vendedores.Anular_Acuerdo_TrabajoExecute(Sender: TObject);
begin
...
procedure TfCuadres_Vendedores.BuscarEnClick(Sender: TObject);
begin
...
procedure TfCuadres_Vendedores.BuscarExecute(Sender: TObject);
  Var
    R : Integer;
    S : String;
begin
...
procedure TfCuadres_Vendedores.DetallesExit(Sender: TObject);
begin
  KeyPreview := True
end;

procedure TfCuadres_Vendedores.Det_AcuerdosEnter(Sender: TObject);
begin
  KeyPreview := False
end;

procedure TfCuadres_Vendedores.Det_AcuerdosExit(Sender: TObject);
begin
  KeyPreview := true
end;

procedure TfCuadres_Vendedores.ImprimirExecute(Sender: TObject);
  Var
...
procedure TfCuadres_Vendedores.Imprimir_Orden_TrabajoExecute(Sender: TObject);
  Var
    OutputFormat : ShortInt;
    PrintFormat  : ShortInt;
...
procedure TfCuadres_Vendedores.DetallesCellChanged(Sender: TObject);
begin
//  If Detalles.SelectedField = Modulo
end;

procedure TfCuadres_Vendedores.CategoriasCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TfCuadres_Vendedores.Configuracion_AcuerdoExecute(Sender: TObject);
begin
...
procedure TfCuadres_Vendedores.Configuracion_Orden_TrabajoExecute(Sender: TObject);
begin
  Application.CreateForm(TFConfigForms,FConfigForms);
...
Initialization
  RegisterClass(TfCuadres_Vendedores);
