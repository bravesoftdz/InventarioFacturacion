object FSeriales_Productos_Despachados: TFSeriales_Productos_Despachados
  Left = 0
  Top = 0
  ActiveControl = Serial
  BorderStyle = bsToolWindow
  Caption = 'Seriales de Productos Despachados'
  ClientHeight = 563
  ClientWidth = 794
  Color = clBtnFace
  ...
  object Detalles_Seriales: TwwDBGrid
    ...
    Ctl3D = False
    DataSource = Modulo.dSeriales_Salida
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Tahoma'
  ...
  object Detalle_Salida: TwwDBGrid
    Left = 3
    Top = 4
    Width = 524
    Height = 185
    ...
    IniAttributes.Enabled = True
    IniAttributes.FileName = 'seriales.grd'
    IniAttributes.SectionName = 'Detalle_Salida'
    IniAttributes.Delimiter = ';;'
    TitleColor = 15400415
    OnRowChanged = Detalle_SalidaRowChanged
    FixedCols = 0
    ShowHorzScrollBar = True
    Ctl3D = False
    ...
    TitleButtons = False
    UseTFields = False
    OnDblClick = Detalle_SalidaDblClick
    PadColumnStyle = pcsPlain
    PaintOptions.AlternatingRowColor = 14217212
  end
