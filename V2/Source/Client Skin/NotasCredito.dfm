object FNotas_Credito: TFNotas_Credito
  ...
  object Panel_Facturas: TAdvPageControl
    ...
    object Pg_Facturas: TAdvTabSheet
      ...
      object Facturas_Cliente: TwwDBGrid
        ...
        IniAttributes.FileName = 'NotasCredito.Grd'
        ...
        OnDblClick = Imprimir_FacturaExecute
  ...
  object Panel_Cuotas: TAdvPageControl
    ...
    object Pg_Cuotas: TAdvTabSheet
      ...
      ExplicitWidth = 0
      ExplicitHeight = 0
      object Cuotas_Facturas: TwwDBGrid
        Left = 0
        Top = 0
        Width = 473
        Height = 129
        ...
        TitleButtons = False
        UseTFields = False
        OnCalcCellColors = Cuotas_FacturasCalcCellColors
        OnDblClick = Cuotas_FacturasDblClick
        PaintOptions.AlternatingRowColor = 15792383
      end
    end
  end
  object Panel_Notas_Credito: TAdvPageControl
    Left = 306
    Top = 327
    Width = 483
    Height = 132
    ActivePage = Pg_Notas_Credito
    ActiveFont.Charset = DEFAULT_CHARSET
    ActiveFont.Color = clWindowText
    ActiveFont.Height = -11
    ActiveFont.Name = 'Tahoma'
    ...
    TabStop = False
    TabWidth = 150
    object Pg_Notas_Credito: TAdvTabSheet
      ...
      ExplicitWidth = 0
      ExplicitHeight = 0
      object Notas_Cliente: TwwDBGrid
        Left = 0
        Top = 0
        Width = 475
        Height = 103
        Selected.Strings = (
          ...
          'Capital'#9'13'#9'Valor Factura'#9'F'#9'Acreditado'
          'Interes'#9'13'#9'Interes'#9'F'#9'Acreditado'
          'Mora'#9'13'#9'Mora'#9'F'#9'Acreditado'
          'Otros'#9'13'#9'Otros'#9'F'#9'Acreditado'
          'NCF'#9'100'#9'NCF'#9'F'
          'NCF_Modificado'#9'100'#9'NCF_Modificado'#9'F'
          'Concepto'#9'100'#9'Concepto'
          'Realizada_Por'#9'100'#9'Realizada_Por'#9'F'
        ...
        TitleButtons = False
        UseTFields = False
        OnCalcCellColors = Notas_ClienteCalcCellColors
  ...
  object Opciones: TActionManager
    ...
    object Configuracion_Comprobante_Nota_Credito: TAction
      Category = 'Opciones'
      Caption = 'Configuraci'#243'n del Comprobante de Nota de Cr'#233'dito'
      ImageIndex = 55
      ShortCut = 49219
      OnExecute = Configuracion_Comprobante_Nota_CreditoExecute
    end
    ...
    object Anular_Nota: TAction
      Category = 'Opciones'
      Caption = 'Anular Nota'
      ImageIndex = 32
      OnExecute = Anular_NotaExecute
    end
  end
  object Opciones_Miscelaneas: TsuiPopupMenu
    ...
    object Pop_Configuracion_Nota_Credito: TMenuItem
      Action = Configuracion_Comprobante_Nota_Credito
    end
  end
