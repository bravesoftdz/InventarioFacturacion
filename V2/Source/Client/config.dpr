...
uses
  ...
  DataModulo in '..\Client Skin\DataModulo.pas' {Modulo: TDataModule},
  FileSelection in '..\Client Skin\FileSelection.pas' {fFileSelection};
...
begin
  ...
  Application.CreateForm(TfFileSelection, fFileSelection);
  Application.Run;
end.
