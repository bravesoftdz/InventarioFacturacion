object FCotizaciones: TFCotizaciones
  ...
  object Panel_Detalles_Cotizacion: TAdvPageControl
    Left = 8
    Top = 201
    Width = 788
    Height = 239
    ActivePage = Pg_Detalles_Cotizacion
    ...
    TabStop = False
    TabWidth = 250
    object Pg_Detalles_Cotizacion: TAdvTabSheet
      Caption = 'Detalles de Cotizaci'#243'n'
      Color = clBtnFace
      ColorTo = clNone
      ImageIndex = 58
      ...
      object Detalles: TwwDBGrid
        ...
        IniAttributes.FileName = 'Cotizaciones.grd'
        IniAttributes.SectionName = 'DetCotizacion'
        IniAttributes.Delimiter = ';;'
        TitleColor = 13428432
        OnCellChanged = DetallesCellChanged
        FixedCols = 0
        ShowHorzScrollBar = True
        DataSource = Modulo.dDetalles_Cotizacion
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
  ...
  object Panel_Datos_Cotizacion: TAdvPageControl
    Left = 5
    Top = 2
    Width = 573
    Height = 193
    ActivePage = Pg_Datos_Cotizacion
    ActiveFont.Charset = DEFAULT_CHARSET
    ActiveFont.Color = clWindowText
    ActiveFont.Height = -11
    ActiveFont.Name = 'Tahoma'
    ...
    TabStop = False
    TabWidth = 250
    object Pg_Datos_Cotizacion: TAdvTabSheet
      Caption = 'Datos de Cotizaci'#243'n'
      Color = clBtnFace
      ColorTo = clNone
      ImageIndex = 58
      TabGradientDirection = gdHorizontal
      ...
      object Referencia: TDBEdit
        ...
        DataSource = Modulo.dCotizaciones
        ParentCtl3D = False
        TabOrder = 6
      end
  ...
  object Opciones: TActionManager
    ...
    object Configuracion_Cotizacion: TAction
      Category = 'Opciones'
      Caption = 'Configuracion de Cotizaciones'
      ImageIndex = 55
      ShortCut = 49219
      OnExecute = Configuracion_CotizacionExecute
    end
    ...
    object Anular_Cotizacion: TAction
      Category = 'Opciones'
      Caption = 'Anular Cotizaci'#243'n'
      ImageIndex = 26
      ShortCut = 49217
      OnExecute = Anular_CotizacionExecute
    end
  ...
  object Opciones_Miscelaneas: TsuiPopupMenu
    ...
    object AnularCotizacin1: TMenuItem
      Action = Anular_Cotizacion
    end
    object N1: TMenuItem
      Caption = '-'
    end
    ...
    object Menu_Configuracion_Cotizaciones: TMenuItem
      Action = Configuracion_Cotizacion
    end
  end
end
