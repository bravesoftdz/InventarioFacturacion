object FSalidas_Inventario: TFSalidas_Inventario
  ...
  Caption = 'Registro y Modificaci'#243'n de Salida de Productos'
  ClientHeight = 555
  ClientWidth = 753
  Color = clBtnFace
  ...
  object Panel_Datos_Generales: TAdvPageControl
    ...
    object Pg_Datos_Generales: TAdvTabSheet
      ...
      object Label6: TLabel
        ...
        Height = 13
        Caption = 'Referencia'
        FocusControl = Referencia_Salida
      end
      ...
      object Referencia_Salida: TDBEdit
        Left = 259
        Top = 1
        Width = 134
        Height = 19
      ...
      object Concepto: TwwDBComboBox
        ...
        HistoryList.FileName = 'Salida_Inventario.hlst'
      ...
      object Clientes: TwwDBLookupCombo
        Left = 48
        Top = 22
        Width = 321
        Height = 19
        ...
        AllowClearKey = False
        ShowMatchText = True
        OnCloseUp = ClientesCloseUp
      end
      object Cedula_RNC: TDBEdit
        Left = 120
        Top = 42
        Width = 249
        Height = 19
    ...
    object Pg_Detalles_Salida: TAdvTabSheet
      ...
      object Detalles: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'Referencia'#9'10'#9'Referencia'#9'F'
          'Descripcion'#9'25'#9'Descripci'#243'n'#9'F'
          'Precio'#9'9'#9'Precio'#9#9
          'Cantidad'#9'7'#9'Cantidad'#9'F'#9
          'Mes'#9'3'#9'Mes'#9#9
          'Ano'#9'4'#9'A'#241'o'#9'F'#9
          'Total_Precio'#9'12'#9'Total'#9'T')
        IniAttributes.FileName = 'Salidas_Inventario.Grd'
        IniAttributes.SectionName = 'Detalles_Salida'
      ...
      object Codigos: TwwDBLookupCombo
        ...
        Selected.Strings = (
          ...
          'Nombre_Fabricante'#9'25'#9'Fabricante'#9'F')
        DataField = 'Codigo'
        DataSource = Modulo.dDetalles_Salida
  ...
  object Comentario: TwwDBRichEdit
    Left = 72
    Top = 457
    Width = 337
    Height = 93
    ...
    Data = {
      ...
      5C706172645C66305C6673313620436F6D656E746172696F5C7061720D0A7D0D
      0A00}
  end
