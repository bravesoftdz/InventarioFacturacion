...
interface
  Var
    ...
    _CuadreCobradorKey      : String = 'SOFTWARE\ThreeTier-IB\GYM\TerminalSide\SystemInformation\GeneralConfig\Cuadres_Cobrador';

    // D
    _DataRootKey            : String;
    _DataRouteKey           : String = 'SOFTWARE\ThreeTier-IB\GYM\TerminalSide\ServerConnection';
    _DespachoCobradorKey    : String = 'SOFTWARE\ThreeTier-IB\GYM\TerminalSide\SystemInformation\GeneralConfig\Despacho_Cobrador';
