object FOrden_Compra_Productos: TFOrden_Compra_Productos
  ...
  object Panel_Detalles_Compra: TAdvPageControl
    ...
    object Pg_Detalles: TAdvTabSheet
      ...
      object Detalles_Compras: TwwDBGrid
        ...
        Selected.Strings = (
          'Codigo'#9'14'#9'C'#243'digo'#9'F'#9'Datos de Facturaci'#243'n'
          'Descripcion'#9'26'#9'Descripci'#243'n'#9'T'#9'Datos de Facturaci'#243'n'
          'Cantidad'#9'8'#9'Cantidad'#9'F'#9'Datos de Compra'
          'Contenido'#9'6'#9'Cont'#9'F'
          'Precio_Lista'#9'10'#9'P. Lista'#9'F'
          'Total_Precio'#9'11'#9'T. Precio'#9'F'
  ...
  object Total_Impuesto: TDBEdit
    ...
    Color = 14089981
    Ctl3D = False
    DataField = 'Valor_Impuesto_Detalle'
    DataSource = Modulo.dOrdenes_Compra
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object Total_Descuento: TDBEdit
    ...
    Color = 14154951
    Ctl3D = False
    DataField = 'Valor_Descuento_Detalle'
    DataSource = Modulo.dOrdenes_Compra
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
