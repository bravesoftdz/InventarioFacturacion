...
procedure TFRecargas.SerialPortTriggerAvail(CP: TObject; Count: Word);
var
  I : Word;
  C : Char;
  S : String;
...
procedure TFRecargas.BuscarExecute(Sender: TObject);
begin
    Try
...
procedure TFRecargas.Cargar_CotizacionExecute(Sender: TObject);
begin
    Try
      Application.CreateForm(TDlgSearch,DlgSearch);
...
procedure TFRecargas.Definir_DepartamentoExecute(Sender: TObject);
begin
    Try
      Application.CreateForm(TDlgSearch,DlgSearch);
