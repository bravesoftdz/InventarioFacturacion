...
uses
  ...
  Empleados in 'Empleados.pas' {FEmpleados},
  ...
  Cuadre_Provisional_Cobradores in 'Cuadre_Provisional_Cobradores.pas' {FCuadre_Cobradores},
  Despacho_Cobradores in 'Despacho_Cobradores.pas' {FDespacho_Cobradores};
