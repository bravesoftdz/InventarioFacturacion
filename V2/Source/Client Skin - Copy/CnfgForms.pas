...
Procedure TFConfigForms.LoadValues;
  ...
  Try
    ...
    Salto_linea.Checked       := RegInfo.ReadBool(_SaltoAutoLinea);
    Estilo.Value              := RegInfo.ReadInteger(_PrinterStyle);
  Except
...
begin
  Try
    ...
    RegInfo.WriteBool(_SaltoAutoLinea,Salto_linea.Checked);
    RegInfo.WriteInteger(_PrinterStyle,Estilo.Value);
