object frmEvaluacion_Inventario: TfrmEvaluacion_Inventario
  Left = 194
  Top = 47
  BorderStyle = bsToolWindow
  Caption = 'Productos no Inventariados'
  ClientHeight = 744
  ClientWidth = 746
  Color = clBtnFace
  ...
  object Detalles_Compra: TAdvPageControl
    ...
    object Page_Detalles: TAdvTabSheet
      ...
      object Detalles: TwwDBGrid
        ...
        IniAttributes.FileName = 'EvaluacionExistencia.Grd'
        IniAttributes.SectionName = 'Ajustes'
        IniAttributes.Delimiter = ';;'
        TitleColor = 13428432
        FixedCols = 0
        ShowHorzScrollBar = True
        DataSource = Modulo.dEvaluacionInventario
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
