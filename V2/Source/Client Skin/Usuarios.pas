...
uses DataModulo, Utilidades, Generales, Autorizaciones;
...
procedure TFUsuarios.FormDblClick(Sender: TObject);
begin
  GuardarExecute(Nuevo);
...
begin
  ...
  ActualCode   := Trim(ModuloGenerales.tUsuariosUserName.Value);
