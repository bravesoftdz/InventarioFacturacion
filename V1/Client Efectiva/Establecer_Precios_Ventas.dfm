object FPrecios_Venta: TFPrecios_Venta
  Left = 251
  Top = 111
  BorderStyle = bsNone
  Caption = 'Verificacion de precios de venta'
  ClientHeight = 240
  ClientWidth = 316
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object Panel_Datos_Venta: TAdvPageControl
    Left = 8
    Top = 5
    Width = 300
    Height = 196
    ActivePage = Pgl_Datos_Venta
    ...
    TabStop = False
    TabWidth = 250
    object Pgl_Datos_Venta: TAdvTabSheet
      ...
      object Label1: TLabel
        ...
        Width = 98
        Height = 13
        Caption = 'Beneficio Por Mayor '
        FocusControl = Valor_Beneficio_PorMayor_Contado
      end
      object Precio_Detalle_Contado: TDBEdit
        ...
        Ctl3D = False
        DataField = 'Precio_Venta_Detalle_Contado'
      ...
      object Precio_Detalle_Credito: TDBEdit
        ...
        CharCase = ecUpperCase
        Ctl3D = False
        DataField = 'Precio_Venta_Detalle_Credito'
        DataSource = Modulo.dDetalles_Compra
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGreen
        Font.Height = -11
      ...
      object Valor_Beneficio_Contado: TDBEdit
        ...
        CharCase = ecUpperCase
        Ctl3D = False
        DataField = 'Valor_Beneficio_Detalle_Contado'
        DataSource = Modulo.dDetalles_Compra
        ParentCtl3D = False
        TabOrder = 2
      end
      ...
      object Valor_Beneficio_PorMayor_Contado: TDBEdit
        Left = 182
        Top = 24
        Width = 105
        Height = 19
        CharCase = ecUpperCase
        Ctl3D = False
        DataField = 'Valor_Beneficio_PMayor_Contado'
        DataSource = Modulo.dDetalles_Compra
        ParentCtl3D = False
        TabOrder = 1
      end
