  ...
  Procedure TDlgSearch.OpenDlg(Const TableName    ,
     ...
     Begin
       ...
       Try
         ...
         DataGrid.IniAttributes.FileName := Path + _BckSlash + SrchCds.RemoteServer.Owner.Name + TableName + '.srch';
         StartUpIni := TIniFile.Create(Path + _BckSlash + SrchCds.RemoteServer.Owner.Name + TableName + '.strt');
...
begin
  ...
  Except
    PopUpMessage(Modulo.Mensajes,'No se suede organizar la busqueda utilizando este campo')
  end;
