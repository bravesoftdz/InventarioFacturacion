object FSalidas_Inventario: TFSalidas_Inventario
  ...
  object Datos_Compra: TAdvPageControl
    ...
    object AdvTabSheet1: TAdvTabSheet
      ...
      object Detalles: TwwDBGrid
        ...
        Selected.Strings = (
          'Secuencia'#9'3'#9'#'#9'T'#9
          'Codigo'#9'15'#9'C'#243'digo'#9#9
          'Mes'#9'3'#9'Mes'#9#9
          'Ano'#9'4'#9'A'#241'o'#9'F'#9
          'Descripcion'#9'28'#9'Descripci'#243'n'#9'F'#9
          'Precio'#9'9'#9'Precio'#9#9
          'Cantidad'#9'7'#9'Cantidad'#9'F'#9
          'Total_Precio'#9'13'#9'Total'#9'T'#9)
  ...
  inline FrameClientes1: TFrameClientes
    Left = 29
    Top = 272
    Width = 580
    Height = 139
