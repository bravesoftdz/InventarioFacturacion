object FFacturacion: TFFacturacion
    ...
    object Pg_Detalles_Factura: TAdvTabSheet
      ...
      object Detalles: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'Referencia'#9'15'#9'Referencia'#9'T'#9'Datos del Producto'
          ...
          'Descuento'#9'5'#9'Desc'#9'T'#9'%'
          'Impuesto'#9'5'#9'Imp.'#9'F'#9'%'
          'Total_Moneda'#9'18'#9'Total'#9'T')
        IniAttributes.Enabled = True
        IniAttributes.FileName = 'formFacturacion.grd'
  ...
  object Panel_Datos_Factura: TAdvPageControl
    ...
    object Pg_Datos_Factura: TAdvTabSheet
      ...
      object chkLayAway: TwwCheckBox
        ...
        DisplayValueChecked = 'LayAway'
        DisplayValueUnchecked = 'LayAway'
        NullAndBlankState = cbUnchecked
        Caption = 'LayAway'
        Ctl3D = False
        DataField = 'LayAway'
  ...
  object Opciones: TActionManager
    ...
    object Modificar_Medida: TAction
      Category = 'Detalles'
      Caption = 'Modificar Medida Venta'
      ImageIndex = 56
      ShortCut = 115
      OnExecute = Modificar_MedidaExecute
    end
    object Aplicar_Descuento: TAction
      Category = 'Detalles'
      Caption = 'Aplicar Descuento'
      ImageIndex = 15
      ShortCut = 116
      OnExecute = Aplicar_DescuentoExecute
    end
  end
