object FModificar_Precio: TFModificar_Precio
  Left = 0
  Top = 0
  ...
  object gbSeleccion_Precio: TcxGroupBox
    Left = 8
    Top = 2
    Caption = 'Selecci'#243'n Precio'
    TabOrder = 2
    Height = 203
    Width = 268
    object rbPrecio_1: TcxRadioButton
      Left = 10
      Top = 20
      Width = 113
      Height = 17
      Caption = 'Precio'
      TabOrder = 0
      OnClick = UncheckOther
    end
    object Precio_Venta_Por_Mayor_Contado: TDBEdit
      Left = 129
      Top = 19
      Width = 127
      Height = 19
    ...
    object rbPrecio_2: TcxRadioButton
      Tag = 1
      Left = 10
      Top = 43
      Width = 113
    ...
    object Precio_Venta_Por_Mayor_Credito: TDBEdit
      Left = 129
      Top = 42
      Width = 127
      Height = 19
    ...
    object rbPrecio_3: TcxRadioButton
      Tag = 2
      Left = 10
      Top = 66
      Width = 113
    ...
    object Precio_Venta_Contado: TDBEdit
      Left = 129
      Top = 65
      Width = 127
      Height = 19
    ...
    object rbPrecio_4: TcxRadioButton
      Tag = 3
      Left = 10
      Top = 90
      Width = 113
    ...
    object Precio_Venta_Credito: TDBEdit
      Left = 129
      Top = 89
      Width = 127
      Height = 19
    ...
    object rbPrecio_Unidad: TcxRadioButton
      Tag = 4
      Left = 10
      Top = 113
      Width = 113
    ...
    object rbPrecio_Minimo: TcxRadioButton
      Tag = 5
      Left = 10
      Top = 137
      Width = 113
    ...
    object Precio_Venta_Minimo: TDBEdit
      Left = 129
      Top = 136
      Width = 127
      Height = 19
    ...
    object rbOtro_Precio: TcxRadioButton
      Tag = 6
      Left = 10
      Top = 160
      Width = 113
    ...
    object Nuevo_Precio: TcxCalcEdit
      Left = 129
      Top = 160
