object FFacturacion: TFFacturacion
  ...
  object Panel_Datos_Entrega: TAdvPageControl
    Left = 8
    Top = 201
    Width = 573
    Height = 97
    ...
    object AdvTabSheet1: TAdvTabSheet
      ...
      object Vendedor: TwwDBLookupCombo
        ...
        DropDownAlignment = taLeftJustify
        Selected.Strings = (
          'NombreCompleto'#9'25'#9'Nombre del Promotor'#9'F'
      ...
      object Cobradores: TwwDBLookupCombo
        Left = 59
        Top = 25
        Width = 305
        Height = 19
        ...
        DropDownAlignment = taLeftJustify
        Selected.Strings = (
          'NombreCompleto'#9'25'#9'Nombre del Cobrador'#9'F'
          'Cedula_Rnc_Pasaporte'#9'25'#9'Cedula_Rnc_Pasaporte'#9'F')
        DataField = 'Empleado'
        DataSource = Modulo.dFacturas
        LookupTable = Modulo.tListadoEmpleados
        LookupField = 'Cedula_Rnc_Pasaporte'
        Options = [loColLines, loRowLines, loTitles, loSearchOnBackspace]
        Style = csDropDownList
        ParentCtl3D = False
      ...
      object Fecha_Primer_Pago: TwwDBDateTimePicker
        Left = 438
        Top = 46
        Width = 127
        Height = 21
  ...
  object Status_Mercancia: TDBEdit
    Left = 635
    Top = 270
    Width = 149
    Height = 19
  ...
  object Opciones_Miscelaneas: TsuiPopupMenu
    ...
    object mnCargar_Cotizacion: TMenuItem
