...
uses
  ...
  Formas_Pago in '..\Gym\Formas_Pago.pas' {FMetodos},
  Apertura_Caja in '..\Gym\Apertura_Caja.pas' {FApertura_Caja},
  ...
  User_Login in '..\Gym\User_Login.pas' {FUser_Login},
  ...
  PagosCtas in 'PagosCtas.pas' {frmPago_Cuentas},
  ...
  Modificar_Medida in 'Modificar_Medida.pas' {FModificar_Medida},
  Cuadre_Caja in 'Cuadre_Caja.pas' {FCuadre_Caja},
  Show_Evaluacion_Inventario in 'Show_Evaluacion_Inventario.pas' {frmEvaluacion_Inventario},
  Registro_Gastos in 'Registro_Gastos.pas' {FRegistro_Gastos},
  cuadres_vendedores in 'cuadres_vendedores.pas' {fCuadres_Vendedores},
  ...
  Devoluciones_Ventas in 'Devoluciones_Ventas.pas' {frmDevolucion_Ventas},
  Acuerdos in 'Acuerdos.pas' {fAcuerdos},
  Productos in 'Productos.pas' {FProductos},
  ShowFoto in 'ShowFoto.pas' {fShowFoto},
  SrchDlg in '..\..\..\Common\SrchDlg.pas' {DlgSearch},
  DataModulo in 'DataModulo.pas' {Modulo: TDataModule},
  Aplicar_Descuento in 'Aplicar_Descuento.pas' {frmAplicar_Descuento},
  ...
  TerminalesUnit in '..\..\..\Common\TerminalesUnit.pas' {frmTerminales},
  ...
  Autorizaciones in '..\..\..\Common\Autorizaciones.pas' {frmAutorizaciones_Accesos},
  Facturacion in 'Facturacion.pas' {FFacturacion},
  Ajuste_Inventario in 'Ajuste_Inventario.pas' {FAjuste_Inventario},
  Conteo_Inventario in 'Conteo_Inventario.pas' {frmConteo_Inventario},
  PagosFacturas in 'PagosFacturas.pas' {FPago_Factura},
  exportar_facturas_unit in 'exportar_facturas_unit.pas' {frmExportar_Facturas};
