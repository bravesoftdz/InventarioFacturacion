...
begin
  If _Load_Create Then
    Begin
      ...
      Modulo.tValidacion_Inventario.FileName := 'VALIDACIONINV.xml';
      Modulo.tValidacion_Inventario.CreateDataSet;
      Modulo.tValidacion_Inventario.Open;

      Modulo.tAjuste_Inventario.Close;
      Modulo.tAjuste_Inventario.FileName := 'AJUSTEINV.xml';
