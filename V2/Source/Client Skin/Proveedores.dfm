object FProveedores: TFProveedores
  ...
  object Panel_Datos_Generales: TAdvPageControl
    ...
    Width = 569
    Height = 488
    ActivePage = Pgl_Datos_Generales
    ActiveFont.Charset = DEFAULT_CHARSET
    ActiveFont.Color = clWindowText
    ActiveFont.Height = -11
    ActiveFont.Name = 'Tahoma'
    ...
    TabStop = False
    TabWidth = 250
    object Pgl_Datos_Generales: TAdvTabSheet
      ...
      object bt_Anadir_Terminos: TSpeedButton
        ...
        Width = 20
        Height = 19
        Hint = 'Editar/A'#241'adir Terminos de Facturaci'#243'n'
        Flat = True
        Glyph.Data = {
      ...
      object bt_Editar_Paises_Ciudades_Sectores_Zonas: TSpeedButton
        ...
        Glyph.Data = {
          ...
          FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00
          FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00FF00}
        OnClick = Editar_Paises_Ciudades_Sectores_ZonasExecute
      end
      ...
      object Tipo_Proveedor: TwwDBComboBox
        Left = 141
        Top = 101
        Width = 157
        Height = 19
      ...
      object Calculo_Impuesto: TwwRadioGroup
        Left = 401
        Top = 320
        Width = 157
        Height = 52
        DisableThemes = False
        Caption = 'Calculo de Impuestos'
        DataField = 'Calculo_Impuesto'
        DataSource = Modulo.dProveedores
        Items.Strings = (
          'Precio Lista'
  ...
  object Opciones: TActionManager
          ...
          item
            Items = <
              ...
              item
                ...
                Caption = 'A'#241'a&dir Terminos de Facturaci'#243'n'
                ImageIndex = 17
              end
              item
                Action = Agregar_Foto
    ...
    object Editar_Paises_Ciudades_Sectores_Zonas: TAction
      Category = 'Opciones'
      Caption = 'Editar_Paises_Ciudades_Sectores_Zonas'
      ImageIndex = 17
      OnExecute = Editar_Paises_Ciudades_Sectores_ZonasExecute
    end
  end
end
