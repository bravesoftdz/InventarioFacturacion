...
type
  TFFacturacion = class(TForm)
    ...
    N6: TMenuItem;
    mnCargar_Cotizacion: TMenuItem;
    Panel_Datos_Entrega: TAdvPageControl;
    ...
    Label26: TLabel;
    Cobradores: TwwDBLookupCombo;
    Label24: TLabel;
    Tarjeta: TDBEdit;
    Label27: TLabel;
    Fecha_Primer_Pago: TwwDBDateTimePicker;
    Status_Mercancia: TDBEdit;
...
begin
   Try
    ...
    Modulo.tFacturasFecha_Cierre.Value := _DeliveryDate;
