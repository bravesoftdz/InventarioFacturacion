...
procedure TFPrintLabels.FormCreate(Sender: TObject);
begin
...
Procedure TFPrintLabels.LoadValues;
  Begin
    Try
      RegInfo.CloseKey;
...
procedure TFPrintLabels.AceptarExecute(Sender: TObject);
  Var
    F   : TextFile;
    U,S : String;
...
procedure TFPrintLabels.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
Var
  Found : TWinControl;
begin
...
procedure TFPrintLabels.CancelarExecute(Sender: TObject);
begin
  Close
end;

Initialization
  RegisterClass(TFPrintLabels);
