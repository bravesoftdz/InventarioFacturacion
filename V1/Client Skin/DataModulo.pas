...
begin
  ...
  If tDetalles_FacturaMedida.Value <> 'Unidad' Then
    Begin
    ...
    End
  Else
      If tDetalles_FacturaTotal_Precio.Value < (tDetalles_FacturaPrecio_Unidad.Value * tDetalles_FacturaCantidad.Value) Then
          Raise Exception.Create(_ErrPrecio_Menor_Precio_Minimo);
...
//      tDetalles_FacturaTipo_Precio.Value   := Trim(tFacturasTipo_Factura.Value) + ' ' + Trim(tFacturasCondicion.Value);
      tDetalles_FacturaTipo_Precio.Value   := 'P-1';
...
begin
  If tDetalles_FacturaMedida.Value <> 'Unidad' Then
    Begin
      tDetalles_FacturaPrecio_Venta.Value := 0;
      If (Trim(tDetalles_FacturaTipo_Precio.Value) = 'P-1') Then tDetalles_FacturaPrecio_Venta.Value  := tProductosPrecio_Venta_Por_Mayor_Contado.Value;
      If (Trim(tDetalles_FacturaTipo_Precio.Value) = 'P-2') Then tDetalles_FacturaPrecio_Venta.Value  := tProductosPrecio_Venta_Por_Mayor_Credito.Value;
      If (Trim(tDetalles_FacturaTipo_Precio.Value) = 'P-3') Then tDetalles_FacturaPrecio_Venta.Value  := tProductosPrecio_Venta_Contado.Value;
      If (Trim(tDetalles_FacturaTipo_Precio.Value) = 'P-4') Then tDetalles_FacturaPrecio_Venta.Value  := tProductosPrecio_Venta_Credito.Value;
