...
type
  TFCompra_Productos = class(TForm)
    ...
    procedure Precios_VentaExecute(Sender: TObject);
  private
...
begin
  S := DoSearch(Nil,
                'Compra_Productos',                                          (* TableName *)
                'SrchPr',                                         (* Provider *)
                Modulo.tCompra_ProductosProceso.FieldName, (* CampoClave *)
                Modulo.tCompra_ProductosNumero.FieldName,      (* CampoInicial *)
                '',      (* AltQry *)
  ...
  If R = MrOk Then
    Begin
          ...
          Modulo.tCompra_Productos.Cancel;
          Modulo.tCompra_Productos.CancelUpdates;
          Modulo.tCompra_Productos.Params.ParamByName('Proceso').AsString := S;
          Modulo.tCompra_Productos.Refresh;
...
procedure TFCompra_Productos.Precios_VentaExecute(Sender: TObject);
begin
...
begin
  ...
  If R = MrOk Then
    Begin
          RegInfo.CloseKey;
          RegInfo.OpenKey(_GeneralConfigKey,False);
          RegInfo.WriteInteger(_DetalleCompraDepto,S)
...
begin
  S := DoSearch(Nil,
                'Ordenes_Compra',                                          (* TableName *)
                'SrchPr',                                         (* Provider *)
                Modulo.tOrdenes_CompraProceso.FieldName, (* CampoClave *)
                Modulo.tOrdenes_CompraNumero.FieldName,      (* CampoInicial *)
                '',      (* AltQry *)
                Modulo.Enlace,                                   (* RemoteServer *)
                'A',                                                              (* SortOrder *)
                -1,                                                               (* Packet Records *)
  ...
  If R = MrOk Then
    Begin
          ...
          Modulo.tOrdenes_Compra.Params.ParamByName('Proceso').AsString := S;
