object FRegistro_Gastos: TFRegistro_Gastos
  Left = 27
  Top = 114
  ...
  object Panel_Datos_Registro: TAdvPageControl
    Left = 5
    Top = 2
    Width = 573
    Height = 271
    ActivePage = Pg_Datos_Registro
    ...
    TabStop = False
    TabWidth = 250
    object Pg_Datos_Registro: TAdvTabSheet
      Caption = 'Detalles'
      Color = clBtnFace
      ColorTo = clNone
      ImageIndex = 58
      ...
      object Label1: TLabel
        ...
        Height = 13
        Caption = 'N'#250'mero'
        FocusControl = NumeroRegistroGasto
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object Referencia: TDBEdit
        ...
        DataSource = Modulo.dRegistro_Gastos
        ParentCtl3D = False
        TabOrder = 6
      end
      ...
      object A_Nombre_De: TwwDBComboBox
        Left = 84
        Top = 26
        Width = 480
        Height = 19
        ...
        HistoryList.FileName = 'Registro_Gastos.hlst'
      ...
      object NumeroRegistroGasto: TDBEdit
        Left = 84
        Top = 1
        Width = 145
        Height = 19
      ...
      object Concepto: TwwDBRichEdit
        ...
        DataSource = Modulo.dRegistro_Gastos
        ParentCtl3D = False
        PrintJobName = 'Comentarios a Regitro de Gastos'
        TabOrder = 7
        WantNavigationKeys = True
        OnEnter = ConceptoEnter
        OnExit = ConceptoExit
      ...
      object Comentarios: TwwDBRichEdit
        ...
        DataSource = Modulo.dRegistro_Gastos
        ParentCtl3D = False
        PrintJobName = 'Comentarios a Registro de Gastos'
        TabOrder = 8
        WantNavigationKeys = True
        OnEnter = ConceptoEnter
        OnSelectionChange = ConceptoExit
        EditorCaption = 'Edit Rich Text'
        EditorPosition.Left = 0
        EditorPosition.Top = 0
        EditorPosition.Width = 0
  ...
  object Opciones: TActionManager
    ...
    object Configuracion_Comprobante: TAction
      Category = 'Opciones'
      Caption = 'Configuracion de Comprobante'
      ImageIndex = 55
      ShortCut = 49219
      OnExecute = Configuracion_ComprobanteExecute
    end
    ...
    object Anular_Registro: TAction
      Category = 'Opciones'
      Caption = 'Anular Registro de Gastos'
      ImageIndex = 26
      ShortCut = 49217
      OnExecute = Anular_RegistroExecute
    end
  end
  object Opciones_Miscelaneas: TsuiPopupMenu
    ...
    Left = 160
    Top = 136
    object AnularRegistro1: TMenuItem
      Action = Anular_Registro
    end
    object N1: TMenuItem
      Caption = '-'
    end
    ...
    object Menu_Configuracion_Comprobante: TMenuItem
      Action = Configuracion_Comprobante
    end
  end
end
