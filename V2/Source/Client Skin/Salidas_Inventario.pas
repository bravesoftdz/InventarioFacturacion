...
uses DataModulo, Utilidades, Categorias, Departamentos,
  ...
  Registry, ConfigForm, Generales, Seriales_Productos_Despachados, ESBDates;
...
begin
  S := DoSearch(Nil,
                'Salidas_Inventario',                                          (* TableName *)
                'SrchPr',                                         (* Provider *)
                Modulo.tSalidas_InventarioProceso.FieldName, (* CampoClave *)
                Modulo.tSalidas_InventarioNumero.FieldName,      (* CampoInicial *)
                '',      (* AltQry *)
  ...
  If R = MrOk Then
    Begin
          ...
          Modulo.tSalidas_Inventario.Cancel;
          Modulo.tSalidas_Inventario.CancelUpdates;
          Modulo.tSalidas_Inventario.Params.ParamByName('Proceso').AsString := S;
          Modulo.tSalidas_Inventario.Refresh;
    ...
    Begin
      Mensaje(Format(_Seriales_Incompletos,[Modulo.tSalidas_InventarioSeriales_Registrados.Text,
                                            ...
                                            IntToStr(Round(Modulo.tSalidas_InventarioTotal_Seriales.Value -
                                                     Modulo.tSalidas_InventarioSeriales_Registrados.Value))]),self);
      Exit
    end;
