...
uses
  ...
  SUIForm, OoMisc, AdPort, Graphics, SUIMgr;
...
type
  TModulo = class(TDataModule)
    ...
    tNotas_DebitoFactura: TStringField;
    tNotas_DebitoTipo_NCF: TStringField;
    tNotas_DebitoNCF: TStringField;
    tNotas_DebitoNCF_Modificado: TStringField;
    tNotas_DebitoMonto: TBCDField;
    tNotas_DebitoConcepto: TStringField;
    tNotas_DebitoCapital: TBCDField;
    tNotas_DebitoInteres: TBCDField;
    tNotas_DebitoMora: TBCDField;
    tNotas_DebitoOtros: TBCDField;
    tNotas_DebitoTotal_Nota: TBCDField;
    tNotas_DebitoRealizada_Por: TStringField;
    tNotas_DebitoVence: TDateField;
    ...
    tMercancia_ClienteCosto: TBCDField;
    tMercancia_ClientePrecio_Real: TBCDField;
    tMercancia_ClientePrecio_Venta: TBCDField;
    tMercancia_ClientePrecio_Minimo: TBCDField;
    tMercancia_ClienteCantidad: TBCDField;
    tMercancia_ClienteTotal_Costo: TBCDField;
    tMercancia_ClienteTotal_Precio: TBCDField;
    ...
    tMercancia_ClienteImpuesto: TBCDField;
    tMercancia_ClienteDescuento: TBCDField;
    tMercancia_ClienteValor_Impuesto: TBCDField;
    tMercancia_ClienteValor_Descuento: TBCDField;
    tMercancia_ClienteTotal_Impuesto: TBCDField;
    tMercancia_ClienteTotal_Descuento: TBCDField;
    ...
    tMercancia_ClienteNumero_Factura: TIntegerField;
...
begin
  If _Load_Create Then
    Begin
      ...
      Try
        _CurrentStore    := RegInfo.ReadString(_DetalleFacturaAlmacen);
      ...
      Enlace.Open;
      Enlace.AppServer.LoginToDb(UnEncrypt(RegInfo.ReadString(_ConectionFile)),'','','');
...
begin
  ...
  Modulo.tDetalles_CompraAlmacen.Value := Modulo.tCompra_ProductosAlmacen.Value;
...
begin
  ...
  If _RestrictInventory Then
    If Trim(Modulo.tListadoProductosTipo_Inventario.Value)  = 'Regular' Then
      If (tDetalles_FacturaCantidad.Value * tDetalles_FacturaContenido.Value) > tListadoProductosExistencia.Value Then
