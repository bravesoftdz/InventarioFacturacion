...
uses
  ...
  SUIForm, ComCtrls, OoMisc, AdPort, Graphics, SUIMgr, AdvOfficeStatusBar,
...
type
  TModulo = class(TDataModule)
    ...
    tFacturas_ClienteSub_Total_Moneda: TBCDField;
    tFacturas_ClienteTotal_Impuesto_Moneda: TBCDField;
    tFacturas_ClienteTotal_Descuento_Moneda: TBCDField;
    tFacturas_ClienteTotal_Moneda: TBCDField;
    tFacturas_ClienteTasa: TBCDField;
    tFacturas_ClienteTotal_Efectivo_Recibido_Moneda: TBCDField;
    tFacturas_ClienteTotal_Efectivo_Devuelto_Moneda: TBCDField;
    ...
    tFacturas_SerialesSub_Total_Moneda: TBCDField;
    tFacturas_SerialesTotal_Impuesto_Moneda: TBCDField;
    tFacturas_SerialesTotal_Descuento_Moneda: TBCDField;
    tFacturas_SerialesTotal_Moneda: TBCDField;
    tFacturas_SerialesTasa: TBCDField;
    tFacturas_SerialesTotal_Efectivo_Recibido_Moneda: TBCDField;
    tFacturas_SerialesTotal_Efectivo_Devuelto_Moneda: TBCDField;
    ...
    tListadoEmpleados: TClientDataSet;
    dListadoEmpleados: TDataSource;
    tListadoEmpleadosCedula_Rnc_Pasaporte: TStringField;
    tListadoEmpleadosNombre: TStringField;
    tListadoEmpleadosApellido: TStringField;
    tListadoEmpleadosTipo_Cliente: TStringField;
    tListadoEmpleadosTipo_Telefono_1: TStringField;
    tListadoEmpleadosTipo_Telefono_2: TStringField;
    tListadoEmpleadosTipo_Telefono_3: TStringField;
    tListadoEmpleadosTipo_Telefono_4: TStringField;
    tListadoEmpleadosNumero_Telefono_1: TStringField;
    tListadoEmpleadosNumero_Telefono_2: TStringField;
    tListadoEmpleadosNumero_Telefono_3: TStringField;
    tListadoEmpleadosNumero_Telefono_4: TStringField;
    tListadoEmpleadosDireccion: TStringField;
    tListadoEmpleadosPais: TStringField;
    tListadoEmpleadosCiudad: TStringField;
    tListadoEmpleadosEstado: TStringField;
    tListadoEmpleadosCondicion_Cliente: TStringField;
    tListadoEmpleadosNombreCompleto: TStringField;
    tListadoEmpleadosStatus: TStringField;
    tListadoEmpleadosFecha_Registro: TDateField;
    tListadoEmpleadosBalance_Actual: TBCDField;
    tListadoEmpleadosmail: TStringField;
    tListadoEmpleadosSecuencia: TIntegerField;
    tListadoEmpleadosProceso: TStringField;
    tListadoEmpleadosFoto: TBlobField;
    tListadoEmpleadosNacionalidad: TStringField;
    tListadoEmpleadosSexo: TStringField;
    tListadoEmpleadosSector: TIntegerField;
    tListadoEmpleadosFecha_Nacimiento: TDateField;
    tListadoEmpleadosEstado_Civil: TStringField;
    tListadoEmpleadosZona: TIntegerField;
    tListadoEmpleadosLugar_Trabajo: TStringField;
    tRenglones_Gastos: TClientDataSet;
    dRenglones_Gastos: TDataSource;
    tRenglones_GastosNombre: TStringField;
    tRenglones_GastosStatus: TStringField;
    tCtas_Cobrar: TClientDataSet;
    dCtas_Cobrar: TDataSource;
    tCtas_CobrarProceso: TStringField;
    tCtas_CobrarID: TStringField;
    tCtas_CobrarConcepto: TStringField;
    tCtas_CobrarNombre: TStringField;
    tCtas_CobrarTipo: TStringField;
    tCtas_CobrarMonto: TBCDField;
    tCtas_CobrarPagado: TBCDField;
    tCtas_CobrarPendiente: TBCDField;
    tCtas_CobrarStatus: TStringField;
    tCuadre_Cobrador: TClientDataSet;
    tCuadre_CobradorProceso: TStringField;
    tCuadre_CobradorNumero: TIntegerField;
    tCuadre_CobradorEmpleado: TStringField;
    tCuadre_CobradorFecha: TDateField;
    tCuadre_CobradorHora_Apertura: TTimeField;
    tCuadre_CobradorHora_Cuadre: TTimeField;
    tCuadre_CobradorStatus: TStringField;
    tCuadre_CobradorUsuario: TStringField;
    tCuadre_CobradorNombre_Empleado: TStringField;
    tCuadre_CobradorMonto_Cobrado: TBCDField;
    tCuadre_CobradorMonto_Recibido: TBCDField;
    tCuadre_CobradorContratos_Despachados: TIntegerField;
    tCuadre_CobradorEfectivo_Entregado: TBCDField;
    tCuadre_CobradorRecibos_Desde: TIntegerField;
    tCuadre_CobradorRecibos_Hasta: TIntegerField;
    tCuadre_CobradorCantidad_Facturas_Gastos: TIntegerField;
    tCuadre_CobradorDiferencia: TBCDField;
    tCuadre_CobradorTipo_Diferencia: TStringField;
    tCuadre_CobradorTotal_Gastos: TBCDField;
    tCuadre_CobradorTotal_Dieta: TBCDField;
    tCuadre_CobradorRecibos_Pago: TIntegerField;
    tCuadre_CobradorContratos_Abonados: TIntegerField;
    tCuadre_CobradorContratos_Saldados: TIntegerField;
    tCuadre_CobradorDevoluciones: TIntegerField;
    tCuadre_CobradorMudados: TIntegerField;
    tCuadre_CobradorComentarios: TStringField;
    tCuadre_CobradorPrestamos: TBCDField;
    tCuadre_CobradorqrDetalles_Dieta_Cuadre: TDataSetField;
    tCuadre_CobradorqrDetalle_Gastos_Cuadre: TDataSetField;
    tDetalle_Gastos_Cuadre: TClientDataSet;
    dDetalle_Gastos_Cuadre: TDataSource;
    tDetalle_Gastos_CuadreProceso: TStringField;
    tDetalle_Gastos_CuadreNumero: TIntegerField;
    tDetalle_Gastos_CuadreRenglon: TStringField;
    tDetalle_Gastos_CuadreMonto: TBCDField;
    tDetalle_Gastos_CuadreComentario: TStringField;
    tDetalle_Gastos_CuadreStatus: TStringField;
    tDetalle_Gastos_CuadreUsuario_Recibido: TStringField;
    tDetalle_Gastos_CuadreUsuario_Validado: TStringField;
    tDetalles_Dieta_Cuadre: TClientDataSet;
    dDetalles_Dieta_Cuadre: TDataSource;
    tDetalles_Dieta_CuadreProceso: TStringField;
    tDetalles_Dieta_CuadreID: TStringField;
    tDetalles_Dieta_CuadreNombre: TStringField;
    tDetalles_Dieta_CuadreNumero: TIntegerField;
    tDetalles_Dieta_CuadreMonto: TBCDField;
    tCuadre_CobradorCantidad_Tarjetas_Despachadas: TIntegerField;
    dCuadre_Cobrador: TDataSource;
    ...
    tDetalles_Dieta_CuadreMonto_Prestamo: TBCDField;
    ...
    procedure tFacturasFecha_CierreValidate(Sender: TField);
    procedure tDetalle_Gastos_CuadreAfterPost(DataSet: TDataSet);
    procedure tDetalles_Dieta_CuadreAfterPost(DataSet: TDataSet);
    procedure Cuadrar_Cobrador(Sender: TField);
    procedure tFacturasEmpleadoValidate(Sender: TField);
  private
...
{    Function ActualizarExistencia(Const Codigo_Producto : String;
  ...
  public
    ...
    Function GenerarCuotas (Var Vence : TDate; Dias : Integer; Const Concepto : String):Boolean;
...
procedure TModulo.Cuadrar_Cobrador(Sender: TField);
  Var
    T : Currency;
begin
  T := (tCuadre_CobradorEfectivo_Entregado.Value +
        tCuadre_CobradorMonto_Cobrado.Value) -
       tCuadre_CobradorTotal_Gastos.Value -
       tCuadre_CobradorTotal_Dieta.Value -
       tCuadre_CobradorPrestamos.Value;

  tCuadre_CobradorDiferencia.Value := T - tCuadre_CobradorMonto_Recibido.Value;

  If tCuadre_CobradorDiferencia.Value = 0 Then tCuadre_CobradorTipo_Diferencia.Value := 'CORRECTO';
  If tCuadre_CobradorDiferencia.Value > 0 Then tCuadre_CobradorTipo_Diferencia.Value := 'FALTANTE';
  If tCuadre_CobradorDiferencia.Value < 0 Then tCuadre_CobradorTipo_Diferencia.Value := 'SOBRANTE';
end;
...
begin
  If _Load_Create Then
    Begin
      ...
      TParametros.Open;
      _DeliveryDate := tParametrosDATECOUNT.Value;
...
procedure TModulo.tDetalles_Dieta_CuadreAfterPost(DataSet: TDataSet);
  Var
    CurrentRecord   : TBookmark;
    Total_Dietas    : Currency;

begin
  CurrentRecord := tDetalles_Dieta_Cuadre.GetBookmark;
  Try
    Total_Dietas   := 0;

    tDetalles_Dieta_Cuadre.DisableControls;
    tDetalles_Dieta_Cuadre.First;

    While Not tDetalles_Dieta_Cuadre.Eof Do
      Begin
        Total_Dietas := tDetalles_Dieta_CuadreMonto.Value + Total_Dietas;
        tDetalles_Dieta_Cuadre.Next
      End;{While}

    tCuadre_CobradorTotal_Dieta.Value := Total_Dietas;
  Finally
    tDetalles_Dieta_Cuadre.GotoBookmark(CurrentRecord);
    tDetalles_Dieta_Cuadre.FreeBookmark(CurrentRecord);
    tDetalles_Dieta_Cuadre.EnableControls
  End {Try}
end;
...
procedure TModulo.tFacturasEmpleadoValidate(Sender: TField);
begin
  tFacturasNombre_Empleado.Value := tListadoEmpleadosNombreCompleto.Value
end;

procedure TModulo.tFacturasFecha_CierreValidate(Sender: TField);
begin
 If tFacturasFecha_Cierre.Value < tFacturasFecha.Value Then
   Begin
     Mensaje ('Esta fecha debe ser mayor o igual a la fecha de facturación');
     SysUtils.Abort;
   End;
...
procedure TModulo.tDetalle_Gastos_CuadreAfterPost(DataSet: TDataSet);
  Var
    CurrentRecord   : TBookmark;
    Total_Gastos    : Currency;

begin
  CurrentRecord := tDetalle_Gastos_Cuadre.GetBookmark;
  Try
    Total_Gastos   := 0;

    tDetalle_Gastos_Cuadre.DisableControls;
    tDetalle_Gastos_Cuadre.First;

    While Not tDetalle_Gastos_Cuadre.Eof Do
      Begin
        Total_Gastos := tDetalle_Gastos_CuadreMonto.Value + Total_Gastos;
        tDetalle_Gastos_Cuadre.Next
      End;{While}

    tCuadre_CobradorTotal_Gastos.Value := Total_Gastos;
  Finally
    tDetalle_Gastos_Cuadre.GotoBookmark(CurrentRecord);
    tDetalle_Gastos_Cuadre.FreeBookmark(CurrentRecord);
    tDetalle_Gastos_Cuadre.EnableControls
  End {Try}
end;
...
Function TModulo.GenerarCuotas (Var Vence : TDate; Dias : Integer; Const Concepto : String):Boolean;
  Var
    I,N     : Integer;
    Capital ,
    Interes ,
            ...
            For I := 1 To tFacturasPlazo_Pago.Value Do
              Begin
                ...
                AnadirCuota (tFacturasProceso.Value,
                             ...
                             Format(Concepto,[IntToStr(N),DateToStr(Vence)]));   // Concepto
