object FTerminos: TFTerminos
  Left = 69
  Top = 129
  BorderStyle = bsToolWindow
  Caption = 'Registro y Modificac'#243'n de T'#233'rminos de Facturaci'#243'n'
  ClientHeight = 229
  ClientWidth = 592
  Color = clBtnFace
  ...
  object Panel_Datos_Generales: TAdvPageControl
    ...
    object Pg_Datos_Generales: TAdvTabSheet
      ...
      object Label6: TLabel
        ...
        Width = 285
        Height = 13
        Caption = 'La Factura vencer'#225' el pr'#243'ximo mes si se realiza despu'#233's del'
        FocusControl = Despues_de
      end
      ...
      object Vence: TDBEdit
        ...
        Height = 19
        Ctl3D = False
        DataField = 'DiasDeGracia'
        DataSource = Modulo.dTerminos
        ParentCtl3D = False
        TabOrder = 1
      end
      object Despues_de: TDBEdit
        Left = 291
        Top = 116
        Width = 46
        Height = 19
        Ctl3D = False
        DataField = 'MargenDeDias'
        DataSource = Modulo.dTerminos
        ParentCtl3D = False
        TabOrder = 2
      end
      object TipoVencimiento: TDBRadioGroup
        Left = 112
        Top = 45
        Width = 155
        Height = 52
        Ctl3D = False
        DataField = 'FormaDeVencimiento'
        DataSource = Modulo.dTerminos
        Items.Strings = (
          'Por &D'#237'as De Vencimiento'
          'En D'#237'as &Espec'#237'ficos')
