object FRecargas: TFRecargas
  Left = 27
  Top = 114
  BorderStyle = bsToolWindow
  Caption = 'Facturaci'#243'n de Recargas'
  ClientHeight = 576
  ClientWidth = 792
  Color = clBtnFace
    ...
    object Pg_Detalles_Factura: TAdvTabSheet
      ...
      object Detalles: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'Cantidad'#9'15'#9'Cant.'#9'F'#9'Datos de Facturaci'#243'n'
          'Precio_Minimo'#9'15'#9'Comision'#9'F'#9'Datos de Facturaci'#243'n'
          'Valor_Moneda'#9'17'#9'Precio'#9'F'#9'Datos de Facturaci'#243'n'
          'Total_Moneda'#9'20'#9'Total'#9'F'#9'Datos de Facturaci'#243'n')
        IniAttributes.Enabled = True
        IniAttributes.FileName = 'cnfgRecargas.grd'
