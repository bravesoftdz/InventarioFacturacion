...
type
  TReportsAndForms = class(TDataModule)
    ...
    repPagos_Nom_Cliente: TppLabel;
    ppLabel415: TppLabel;
    ppDBText243: TppDBText;
    Reporte_Inscripciones: TppReport;
    ...
    Pipe_Cuotas_Facturas: TppDBPipeline;
    ...
    ppLabel473: TppLabel;
    Estatus_Cuota: TppLabel;
    FormCuadre_Cobrador: TppReport;
    ...
    Pipe_Cuadre_Cobrador: TppDBPipeline;
    ppDesignLayers6: TppDesignLayers;
    ppDesignLayer6: TppDesignLayer;
    PipeDetalle_Gastos_Cuadre: TppDBPipeline;
    PipeDetalles_Dieta_Cuadre: TppDBPipeline;
    Pipe_Empleados: TppDBPipeline;
    ppShape44: TppShape;
    ppLabel902: TppLabel;
    ...
    FormDespacho_Cobrador: TppReport;
    ...
    ppLabel981: TppLabel;
    ppLabel991: TppLabel;
    Reportes_Ventas_Cobrador: TppReport;
    ppTitleBand56: TppTitleBand;
    ppLabel966: TppLabel;
    ppLabel970: TppLabel;
    ppLabel971: TppLabel;
    ppHeaderBand39: TppHeaderBand;
    Clasificacion_Cobrador: TppLabel;
    Nombre_Reporte_Cobrador: TppLabel;
    ...
    Reportes_Ventas_Promotor: TppReport;
    ppTitleBand57: TppTitleBand;
    ppLabel973: TppLabel;
    ppLabel974: TppLabel;
    ppLabel975: TppLabel;
    ppHeaderBand40: TppHeaderBand;
    Clasificacion_Promotor: TppLabel;
    Nombre_Reporte_Promotor: TppLabel;
    ...
    procedure ppDetailBand24BeforePrint(Sender: TObject);
    procedure FiltrarCuotas(Sender: TObject);
    procedure ppDetailBand55BeforePrint(Sender: TObject);
  private
...
procedure TReportsAndForms.FiltrarCuotas(Sender: TObject);
begin
  ParamSearchKey(Modulo.tCuotas_Facturas,'Proceso',Pipe_Facturas.DataSource.DataSet.FieldByName('Proceso').AsString);
  Modulo.tCuotas_Facturas.Filter := 'Vence <= ' + QuotedStr(FormatDateTime('mm/dd/yyyy',Modulo.Enlace.AppServer.ServerDate + 1));
  Modulo.tCuotas_Facturas.Filtered := True;
end;
...
procedure TReportsAndForms.ppDetailBand24BeforePrint(Sender: TObject);
begin
  ParamSearchKey(Modulo.tClientes,'Cedula_Rnc_Pasaporte',PipePagos.DataSource.DataSet.FieldByName('Cliente').Value);
  repPagos_Nom_Cliente.Text := Modulo.tClientesNombreCompleto.Value
end;
...
procedure TReportsAndForms.ppDetailBand55BeforePrint(Sender: TObject);
begin
  Estatus_Cuota.Caption := #32;
  If Pipe_Cuotas_Facturas.DataSource.DataSet.FieldByName('Total_Pendiente').AsCurrency <> Pipe_Cuotas_Facturas.DataSource.DataSet.FieldByName('Monto').AsCurrency Then Estatus_Cuota.Caption := '-';
  If Pipe_Cuotas_Facturas.DataSource.DataSet.FieldByName('Vence').AsCurrency < Modulo.Enlace.AppServer.ServerDate Then Estatus_Cuota.Caption := '*';
  If Pipe_Cuotas_Facturas.DataSource.DataSet.FieldByName('Total_Pendiente').AsCurrency <= _Margen Then Estatus_Cuota.Caption := 'X';
end;
