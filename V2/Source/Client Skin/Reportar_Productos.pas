...
type
  TFSeleccion_Productos = class(TForm)
...
var
  FSeleccion_Productos: TFSeleccion_Productos;
...
procedure TFSeleccion_Productos.FormActivate(Sender: TObject);
begin
  Modulo.tListadoProductos.Open
end;

procedure TFSeleccion_Productos.SeleccionClick(Sender: TObject);
  Var
...
procedure TFSeleccion_Productos.FormCreate(Sender: TObject);
begin
...
Initialization
  RegisterClass(TFSeleccion_Productos);
