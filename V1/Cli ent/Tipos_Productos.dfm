object FTipos_Productos: TFTipos_Productos
  Left = 54
  Top = 101
  BorderStyle = bsToolWindow
  Caption = 'Registro y Modificac'#243'n de Tipos de Productos'
  ClientHeight = 142
  ClientWidth = 569
  Color = clBtnFace
  ...
  object Datos_Generales: TAdvPageControl
    ...
    object DatosGenerales: TAdvTabSheet
      ...
      object Descripcion: TwwDBComboBox
        ...
        DataSource = Modulo.dTipos_Productos
        DropDownCount = 15
        ...
        HistoryList.Section = 'Tipos_Productos'
        HistoryList.FileName = 'Tipos_Productos.hlst'
  ...
  object Page_Botones: TAdvPageControl
    ...
    object Botones: TAdvTabSheet
      ...
      TabColor = clBlack
      TabColorTo = clOlive
      object atv_Botones: TActionToolBar
        Left = 0
        Top = 0
        Width = 153
        Height = 81
