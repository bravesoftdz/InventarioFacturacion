...
begin
  ...
  If _WindowsExitMode = MrOk Then
    Begin
      ...
      Modulo.tDetalles_FacturaPrecio_Venta.Value := _NuevoPrecio;
...
procedure TFCotizaciones.Anular_FacturaExecute(Sender: TObject);
begin
 {Codigo Para Anular la Factura}
end;

procedure TFCotizaciones.Autorizacion_CobroExecute(Sender: TObject);
  Var
    DoPreview    : Boolean;
    OutputFormat : ShortInt;
    PrintFormat  : ShortInt;
...
procedure TFCotizaciones.Procesar_PagoExecute(Sender: TObject);
begin
  Comentarios.SetFocus;
...
procedure TFCotizaciones.Comentario_CreditoClick(Sender: TObject);
begin
  RegInfo.CloseKey;
  RegInfo.OpenKey(_FacturaProductosKey,False);
...
procedure TFCotizaciones.Condicion_FacturaClick(Sender: TObject);
begin
...
procedure TFCotizaciones.Configuracion_FacturaExecute(Sender: TObject);
begin
...
procedure TFCotizaciones.Registrar_SerialesExecute(Sender: TObject);
begin
  GuardarExecute(Sender);
  Try
