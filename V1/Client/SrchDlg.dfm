object DlgSearch: TDlgSearch
  ...
  object SrchCds: TClientDataSet
    ...
    FieldDefs = <
      ...
      item
        Name = 'Telefono_Cuarto'
        DataType = ftString
        Size = 13
      end
      item
        Name = 'Tipo_Telefono_Principal'
        DataType = ftString
        Size = 75
      end
      item
      ...
      item
        Name = 'Tipo_Telefono_Tercero'
        DataType = ftString
        Size = 75
      end
      item
        Name = 'Tipo_Telefono_Cuarto'
        DataType = ftString
        Size = 75
      end
      item
      ...
      item
        Name = 'Municipio_Electoral'
        Attributes = [faRequired]
        DataType = ftInteger
      end
      item
        Name = 'PresidenteComite'
        DataType = ftSmallint
      end
      item
        Name = 'EstadoCivil'
