...
begin
  ...
  Modulo.tExistenciaInicial.Params.ParamByName('Proceso').Value := Modulo.tProductosCodigo.Value;
  Modulo.tExistenciaInicialPrecio_Venta_Detalle_Contado.Value := Modulo.tProductosPrecio_Venta_Contado.Value;
  Modulo.tExistenciaInicialPrecio_Venta_Por_Mayor_Contado.Value := Modulo.tProductosPrecio_Venta_Por_Mayor_Contado.Value;
  Modulo.tExistenciaInicialPrecio_Venta_Detalle_Credito.Value := Modulo.tProductosPrecio_Venta_Credito.Value;
  Modulo.tExistenciaInicialPrecio_Venta_Por_Mayor_Credito.Value := Modulo.tProductosPrecio_Venta_Por_Mayor_Credito.Value;
end;
