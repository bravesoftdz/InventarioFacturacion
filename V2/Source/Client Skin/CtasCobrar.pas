...
begin
  ...
  Modulo.tPagos_ClientesNombre_Cliente.Value := Modulo.tClientesNombre.Value + ' ' + Modulo.tClientesApellido.Value;
...
begin
  Mensaje(Modulo.tCuotas_FacturasConcepto.Value + #13'PENDIENTE :' +Modulo.tCuotas_FacturasTotal_Pendiente.Text,self) 
end;
...
begin
  ...
  If Trim(Modulo.tPagos_ClientesStatus.Value) = _stANULADO Then
    Begin
      Mensaje('Ese Recibo ya fue ANULADO'#13'Por Favor, VERIFIQUE',self);
      Exit
    End;
      ...
      Begin
        If (Modulo.tCuotas_FacturasMora_Pendiente.Value > _Margen) And (Restante > 0) And (PagarMora.Checked) Then
          Begin
            ...
            Modulo.TDetalle_Pago_Clientes.Append;
            Modulo.tDetalle_Pago_ClientesProceso_Factura.Value := Modulo.tFacturas_ClienteProceso.Text;
            Modulo.tDetalle_Pago_ClientesFactura.Value := Modulo.tFacturas_ClienteNumero.Text;
            Modulo.tDetalle_Pago_ClientesCliente.Value := Modulo.tFacturas_ClienteCliente.Value;
          ...
          Begin
            If (Modulo.tCuotas_FacturasInteres_Pendiente.Value >= _Margen) And (Restante > 0) And (PagarInteres.Checked) Then
              Begin
                Modulo.TDetalle_Pago_Clientes.Append;
                Modulo.tDetalle_Pago_ClientesProceso_Factura.Value := Modulo.tFacturas_ClienteProceso.Text;
                Modulo.tDetalle_Pago_ClientesCliente.Value := Modulo.tFacturas_ClienteCliente.Text;
                Modulo.tDetalle_Pago_ClientesFactura.Value := Modulo.tFacturas_ClienteNumero.Text;
                Modulo.TDetalle_Pago_ClientesCuota.Value := Modulo.tCuotas_FacturasNumero.Value;
                Modulo.TDetalle_Pago_ClientesVencimiento.Value := Modulo.tCuotas_FacturasVence.Value;
...
begin
  ...
  If OpenForm(TfrmPago_Cuentas,frmPago_Cuentas) = MrOk Then
    Begin
...

    {
      ...
      While Not Modulo.tFacturas_Cliente.EOF Do
        Begin
          If Modulo.tFacturas_ClientePendiente.Value > _Margen Then
             Restante := PagarCuotas(Restante,Capital,Interes,Mora,Otros);
    ...
    _GraphicForm : Begin
                     ...
                     With ReportsAndForms.ReciboPagoCliente Do
                       Begin
                         ...
                         Modulo.tForma_Pagos_Clientes.Filter := 'Valor_Recibido <> 0';
                         Modulo.tForma_Pagos_Clientes.Filtered := True;
                         Print;
                         Modulo.tForma_Pagos_Clientes.Filtered := False;
                       End // With
                   End // _GraphicForm
  End; // Case
