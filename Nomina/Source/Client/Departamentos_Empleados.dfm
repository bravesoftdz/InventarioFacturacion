object FDepartamentos_Nomina: TFDepartamentos_Nomina
  Left = 51
  Top = 107
  BorderStyle = bsToolWindow
  Caption = 'Registro y Modificac'#243'n de Departamentos'
  ClientHeight = 248
  ClientWidth = 518
  Color = clBtnFace
  ...
  object Datos_Generales: TAdvPageControl
    ...
    object DatosGenerales: TAdvTabSheet
      ...
      object Descripcion: TwwDBComboBox
        ...
        DataSource = ModuloNomina.dDepartamentos
        ...
        HistoryList.FileName = 'Departamentos.hlst'
  ...
  object atb_Botones: TAdvPageControl
    Left = 371
    Top = 30
    Width = 131
    Height = 212
