...
begin
  ...
  If Self.Visible And _MoveFocus Then Codigo3Char.SetFocus;
...
begin
  ...
  ModuloGenerales.Mensajes.Text := _DatosGuardados;
  ModuloGenerales.Mensajes.ShowPopUp
end;
...
begin
  SearchResult := SearchCountry(Codigo3Char.Text);
...
begin
  If ModuloGenerales.tCiudades.RecordCount = 0 Then
    Begin
      ModuloGenerales.Mensajes.Text := _ErrNoCiudadParaSector_Zona;
      ModuloGenerales.Mensajes.ShowPopUp;
      Exit
    End;
...
procedure TFPaises.PanelesTabSlideIn(Sender: TObject; Index: Integer;
