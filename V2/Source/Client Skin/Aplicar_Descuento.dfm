object frmAplicar_Descuento: TfrmAplicar_Descuento
  Left = 0
  Top = 0
  ...
  object rgTipo_Descuento: TcxRadioGroup
    Left = 8
    Top = 1
    ...
    Properties.OnChange = rgTipo_DescuentoPropertiesChange
    ItemIndex = 0
    TabOrder = 0
    Height = 47
    Width = 268
  end
  object Monto_Descuento: TcxCalcEdit
    Left = 155
    Top = 53
