object Modulo: TModulo
  ...
  object Enlace: TSocketConnection
    ServerGUID = '{FE2D2862-63F0-4E4A-9996-7B534DA8CA93}'
  ...
  object tProductos: TClientDataSet
    ...
    object tProductosPrecio_Venta_Por_Mayor_Credito: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Venta_Por_Mayor_Credito'
      Origin = '"Productos"."Precio_Venta_Por_Mayor_Credito"'
    end
    object tProductosPrecio_Unidad: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Unidad'
      Origin = '"Productos"."Precio_Unidad"'
    end
    object tProductosExistencia_Medida: TBCDField
      AutoGenerateValue = arDefault
  ...
  object tDepartamentos: TClientDataSet
    ...
    object tDepartamentosID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
  ...
  object tSalidas_Inventario: TClientDataSet
    ...
    object tSalidas_InventarioID: TStringField
      FieldName = 'ID'
  ...
  object tDetalles_Salida: TClientDataSet
    ...
    object tDetalles_SalidaID: TStringField
      FieldName = 'ID'
  ...
  object tListadoProductos: TClientDataSet
    ...
    object tListadoProductosExistencia_Medida: TBCDField
      AutoGenerateValue = arDefault
    ...
    object tListadoProductosPrecio_Venta_Contado: TFloatField
      AutoGenerateValue = arDefault
      DisplayLabel = 'Precio'
      DisplayWidth = 10
      FieldName = 'Precio_Venta_Contado'
    ...
    object tListadoProductosUltimo_Precio_Compra: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Ultimo_Precio_Compra'
      Origin = '"Productos"."Ultimo_Precio_Compra"'
      Visible = False
    end
    object tListadoProductosCosto_Standar: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Costo_Standar'
      Origin = '"Productos"."Costo_Standar"'
      Visible = False
    end
    object tListadoProductosCosto_Promedio: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Costo_Promedio'
      Origin = '"Productos"."Costo_Promedio"'
      Visible = False
    end
    object tListadoProductosPrecio_Venta_Credito: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Venta_Credito'
      Origin = '"Productos"."Precio_Venta_Credito"'
      Visible = False
    end
    object tListadoProductosPrecio_Venta_Minimo: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Venta_Minimo'
      Origin = '"Productos"."Precio_Venta_Minimo"'
      Visible = False
    end
    object tListadoProductosPrecio_Venta_Por_Mayor_Contado: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Venta_Por_Mayor_Contado'
      Origin = '"Productos"."Precio_Venta_Por_Mayor_Contado"'
      Visible = False
    end
    object tListadoProductosPrecio_Venta_Por_Mayor_Credito: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Venta_Por_Mayor_Credito'
      Origin = '"Productos"."Precio_Venta_Por_Mayor_Credito"'
      Visible = False
    end
    object tListadoProductosPrecio_Unidad: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Unidad'
      Origin = '"Productos"."Precio_Unidad"'
      Visible = False
  ...
  object tCompra_Productos: TClientDataSet
    ...
    object tCompra_ProductosID: TStringField
      FieldName = 'ID'
  ...
  object tDetalles_Compra: TClientDataSet
    ...
    object tDetalles_CompraID: TStringField
      FieldName = 'ID'
  ...
  object tFacturas: TClientDataSet
    ...
    object tFacturasID: TStringField
      FieldName = 'ID'
      Origin = '"Facturas"."ID"'
      Size = 50
    end
  ...
  object tDetalles_Factura: TClientDataSet
    ...
    AfterScroll = tDetalles_FacturaAfterScroll
    BeforeRefresh = ChkRefresh
    Left = 224
    Top = 335
    ...
    object tDetalles_FacturaCosto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Costo'
      Origin = '"Detalles_Factura"."Costo"'
    end
    object tDetalles_FacturaPrecio_Real: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Real'
      Origin = '"Detalles_Factura"."Precio_Real"'
    end
    object tDetalles_FacturaPrecio_Venta: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Venta'
      Origin = '"Detalles_Factura"."Precio_Venta"'
      OnValidate = Calculo_Totales_Detalle_Factura
    end
    object tDetalles_FacturaPrecio_Minimo: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Minimo'
      Origin = '"Detalles_Factura"."Precio_Minimo"'
    end
    object tDetalles_FacturaTotal_Costo: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Costo'
      Origin = '"Detalles_Factura"."Total_Costo"'
    end
    object tDetalles_FacturaTotal_Precio: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Precio'
      Origin = '"Detalles_Factura"."Total_Precio"'
    end
    object tDetalles_FacturaImpuesto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Impuesto'
      Origin = '"Detalles_Factura"."Impuesto"'
      OnValidate = Calculo_Totales_Detalle_Factura
    end
    object tDetalles_FacturaDescuento: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Descuento'
      Origin = '"Detalles_Factura"."Descuento"'
      OnValidate = Calculo_Totales_Detalle_Factura
    end
    object tDetalles_FacturaValor_Impuesto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Impuesto'
      Origin = '"Detalles_Factura"."Valor_Impuesto"'
    end
    object tDetalles_FacturaValor_Descuento: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Descuento'
      Origin = '"Detalles_Factura"."Valor_Descuento"'
    end
    object tDetalles_FacturaTotal_Impuesto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Impuesto'
      Origin = '"Detalles_Factura"."Total_Impuesto"'
    end
    object tDetalles_FacturaTotal_Descuento: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Descuento'
      Origin = '"Detalles_Factura"."Total_Descuento"'
    end
    object tDetalles_FacturaUnidades: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Unidades'
    ...
    object tDetalles_FacturaPrecio_Unidad: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Unidad'
      Origin = '"Detalles_Factura"."Precio_Unidad"'
    end
    object tDetalles_FacturaMedida: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Medida'
      Origin = '"Detalles_Factura"."Medida"'
      OnValidate = tDetalles_FacturaMedidaValidate
      Size = 25
    end
    object tDetalles_FacturaUsuario_Autorizacion: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Usuario_Autorizacion'
      Origin = '"Detalles_Factura"."Usuario_Autorizacion"'
      Size = 100
    end
    object tDetalles_FacturaProc_Detalle: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Proc_Detalle'
      Origin = '"Detalles_Factura"."Proc_Detalle"'
      Size = 25
    end
    object tDetalles_FacturaID: TStringField
      FieldName = 'ID'
  ...
  object tDetalle_Pago_Factura: TClientDataSet
    ...
    object tDetalle_Pago_FacturaPendiente: TBCDField
      FieldName = 'Pendiente'
    ...
    object tDetalle_Pago_FacturaID: TStringField
      FieldName = 'ID'
  ...
  object tComponentes: TClientDataSet
    Aggregates = <>
    DataSetField = tProductosqrComponentes
    Params = <>
  ...
  object tCuadre_Caja: TClientDataSet
    ...
    object tCuadre_CajaID: TStringField
      FieldName = 'ID'
  ...
  object tDetalle_Cuadre: TClientDataSet
    ...
    object tDetalle_CuadreID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tRetiros_Caja: TClientDataSet
    ...
    object tRetiros_CajaID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tFacturas_Cliente: TClientDataSet
    ...
    object tFacturas_ClienteAlmacen: TStringField
      FieldName = 'Almacen'
      Origin = '"Facturas"."Almacen"'
      Size = 25
    end
    object tFacturas_ClienteApertura: TStringField
      FieldName = 'Apertura'
      Origin = '"Facturas"."Apertura"'
      Size = 25
    end
    object tFacturas_ClienteID: TStringField
      FieldName = 'ID'
      Origin = '"Facturas"."ID"'
      Size = 50
    end
  ...
  object tPagos_Clientes: TClientDataSet
    ...
    object tPagos_ClientesID: TStringField
      FieldName = 'ID'
  ...
  object tDetalle_Pago_Clientes: TClientDataSet
    ...
    object tDetalle_Pago_ClientesID: TStringField
      FieldName = 'ID'
  ...
  object tExistenciaInicial: TClientDataSet
    ...
    object tExistenciaInicialRegistro_Compra: TIntegerField
      FieldName = 'Registro_Compra'
    end
    object tExistenciaInicialUso_Inmediato: TBooleanField
      FieldName = 'Uso_Inmediato'
    end
    object tExistenciaInicialCantidad_Despachada: TBCDField
      FieldName = 'Cantidad_Despachada'
      Precision = 12
      Size = 2
    end
    object tExistenciaInicialConcepto_Uso: TStringField
      FieldName = 'Concepto_Uso'
      Size = 255
    end
    object tExistenciaInicialRequiere_Serial: TBooleanField
      FieldName = 'Requiere_Serial'
    end
    object tExistenciaInicialAlmacen: TStringField
      FieldName = 'Almacen'
      Size = 25
    end
    object tExistenciaInicialID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tDesgloceEfectivo: TClientDataSet
    ...
    object tDesgloceEfectivoID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tListadoPagos: TClientDataSet
    ...
    object tListadoPagosID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tNotas_Credito: TClientDataSet
    ...
    object tNotas_CreditoID: TStringField
      FieldName = 'ID'
  ...
  object tDetalle_Notas_Credito: TClientDataSet
    ...
    object tDetalle_Notas_CreditoID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tComprobantes_Fiscales: TClientDataSet
    ...
    object tComprobantes_FiscalesID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tOrdenes_Compra: TClientDataSet
    ...
    object tOrdenes_CompraID: TStringField
      FieldName = 'ID'
  ...
  object tDetalles_Orden_Compra: TClientDataSet
    ...
    object tDetalles_Orden_CompraID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tCuotas: TClientDataSet
    ...
    object tCuotasOtros_Pendiente: TBCDField
    ...
    object tCuotasFecha_Ultimo_Pago: TDateField
      FieldName = 'Fecha_Ultimo_Pago'
      Origin = '"Cuotas"."Fecha_Ultimo_Pago"'
    end
    object tCuotasID: TStringField
      FieldName = 'ID'
      Origin = '"Cuotas"."ID"'
      Size = 50
    end
  ...
  object tCuotas_Facturas: TClientDataSet
    ...
    object tCuotas_FacturasID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tFacturas_Proveedor: TClientDataSet
    ...
    object tFacturas_ProveedorAlmacen: TStringField
      FieldName = 'Almacen'
      Size = 25
    end
    object tFacturas_ProveedorID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tNotas_Debito: TClientDataSet
    ...
    object tNotas_DebitoNombre_Cliente: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Nombre_Cliente'
    ...
    object tNotas_DebitoReferencia: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Referencia'
      Origin = '"Notas_Debito"."Referencia"'
      Size = 25
    end
    object tNotas_DebitoSubTotal: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'SubTotal'
    ...
    object tNotas_DebitoTotalNeto: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'TotalNeto'
    ...
    object tNotas_DebitoComentario: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Comentario'
      Origin = '"Notas_Debito"."Comentario"'
      Size = 255
    end
    object tNotas_DebitoFecha_Validacion: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'Fecha_Validacion'
      Origin = '"Notas_Debito"."Fecha_Validacion"'
    end
    object tNotas_DebitoFecha_Cierre: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'Fecha_Cierre'
      Origin = '"Notas_Debito"."Fecha_Cierre"'
    end
    object tNotas_DebitoUsuario: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Usuario'
      Origin = '"Notas_Debito"."Usuario"'
      Size = 100
    end
    object tNotas_DebitoValidado: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Validado'
      Origin = '"Notas_Debito"."Validado"'
    end
    object tNotas_DebitoCerrado: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Cerrado'
      Origin = '"Notas_Debito"."Cerrado"'
    end
    object tNotas_DebitoImpuesto_Global: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Impuesto_Global'
    ...
    object tNotas_DebitoValor_Impuesto: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Impuesto'
    ...
    object tNotas_DebitoValor_Impuesto_Detalle: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Impuesto_Detalle'
    ...
    object tNotas_DebitoTotal_Impuesto: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Impuesto'
    ...
    object tNotas_DebitoDescuento_Global: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Descuento_Global'
    ...
    object tNotas_DebitoValor_Descuento: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Descuento'
    ...
    object tNotas_DebitoValor_Descuento_Detalle: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Descuento_Detalle'
    ...
    object tNotas_DebitoTotal_Descuento: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Descuento'
    ...
    object tNotas_DebitoTerminos: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'Terminos'
      Origin = '"Notas_Debito"."Terminos"'
    end
    object tNotas_DebitoVencimiento: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'Vencimiento'
      Origin = '"Notas_Debito"."Vencimiento"'
    end
    object tNotas_DebitoPagado: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Pagado'
    ...
    object tNotas_DebitoPendiente: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Pendiente'
    ...
    object tNotas_DebitoUltimoPago: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'UltimoPago'
    ...
    object tNotas_DebitoTotal_Efectivo_Recibido: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Efectivo_Recibido'
    ...
    object tNotas_DebitoTotal_Efectivo_Devuelto: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Efectivo_Devuelto'
    ...
    object tNotas_DebitoID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
  ...
  object tDetalles_Notas_Debito: TClientDataSet
    ...
    object tDetalles_Notas_DebitoID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
      Origin = '"Cuotas"."ID"'
      Size = 50
  ...
  object tListado_Facturas: TClientDataSet
    ...
    object tListado_FacturasDebitado: TBCDField
      FieldName = 'Debitado'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasAcreditado: TBCDField
      FieldName = 'Acreditado'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasBalance: TBCDField
      FieldName = 'Balance'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasMora: TBCDField
      FieldName = 'Mora'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasMonto_Vencido: TBCDField
      FieldName = 'Monto_Vencido'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasCuotas_Vencidas: TIntegerField
      FieldName = 'Cuotas_Vencidas'
    end
    object tListado_FacturasMonto_Interes_Cumplido: TBCDField
      FieldName = 'Monto_Interes_Cumplido'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasBalance_Capital: TBCDField
      FieldName = 'Balance_Capital'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasBalance_Interes: TBCDField
      FieldName = 'Balance_Interes'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasBalance_Otros: TBCDField
      FieldName = 'Balance_Otros'
      Precision = 12
      Size = 2
    end
    object tListado_FacturasFecha_Ultimo_Pago: TDateField
      FieldName = 'Fecha_Ultimo_Pago'
    end
    object tListado_FacturasDias_Vencidos: TIntegerField
      FieldName = 'Dias_Vencidos'
    end
    object tListado_FacturasTotal_Seriales: TIntegerField
      FieldName = 'Total_Seriales'
    end
    object tListado_FacturasSeriales_Registrados: TIntegerField
      FieldName = 'Seriales_Registrados'
    end
    object tListado_FacturasAlmacen: TStringField
      FieldName = 'Almacen'
      Size = 25
    end
    object tListado_FacturasApertura: TStringField
      FieldName = 'Apertura'
      Size = 25
    end
    object tListado_FacturasID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tSeriales_Compra: TClientDataSet
    ...
    object tSeriales_CompraModalidad_Servicio: TStringField
      AutoGenerateValue = arDefault
      DefaultExpression = #39'N/A'#39
      FieldName = 'Modalidad_Servicio'
      Size = 25
    end
    object tSeriales_CompraID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tCompras_Seriales: TClientDataSet
    ...
    object tCompras_SerialesAlmacen: TStringField
      FieldName = 'Almacen'
      Size = 25
    end
    object tCompras_SerialesID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tSeriales_Factura: TClientDataSet
    ...
    object tSeriales_FacturaProc_Detalle: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Proc_Detalle'
      Size = 25
    end
    object tSeriales_FacturaID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tSeriales_Comprados: TClientDataSet
    ...
    object tSeriales_CompradosModalidad_Servicio: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Modalidad_Servicio'
      Size = 25
    end
    object tSeriales_CompradosID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
      Size = 50
    end
  ...
  object tSeriales_Facturados: TClientDataSet
    ...
    object tSeriales_FacturadosProc_Detalle: TStringField
      FieldName = 'Proc_Detalle'
      Size = 25
    end
    object tSeriales_FacturadosID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tFacturas_Seriales: TClientDataSet
    ...
    object tFacturas_SerialesAlmacen: TStringField
      FieldName = 'Almacen'
      Size = 25
    end
    object tFacturas_SerialesApertura: TStringField
      FieldName = 'Apertura'
      Size = 25
    end
    object tFacturas_SerialesID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tSeriales_Salida: TClientDataSet
    ...
    object tSeriales_SalidaProc_Detalle: TStringField
      FieldName = 'Proc_Detalle'
      Size = 25
    end
    object tSeriales_SalidaID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tMercancia_Cliente: TClientDataSet
    ...
    object tMercancia_ClienteCosto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Costo'
      Origin = '"Detalles_Factura"."Costo"'
      currency = True
    end
    object tMercancia_ClientePrecio_Real: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Real'
      Origin = '"Detalles_Factura"."Precio_Real"'
      currency = True
    end
    object tMercancia_ClientePrecio_Venta: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Venta'
      Origin = '"Detalles_Factura"."Precio_Venta"'
      currency = True
    end
    object tMercancia_ClientePrecio_Minimo: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Minimo'
      Origin = '"Detalles_Factura"."Precio_Minimo"'
      currency = True
    ...
    object tMercancia_ClienteTotal_Costo: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Costo'
      Origin = '"Detalles_Factura"."Total_Costo"'
      currency = True
    end
    object tMercancia_ClienteTotal_Precio: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Precio'
      Origin = '"Detalles_Factura"."Total_Precio"'
      currency = True
    ...
    object tMercancia_ClienteImpuesto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Impuesto'
      Origin = '"Detalles_Factura"."Impuesto"'
    end
    object tMercancia_ClienteDescuento: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Descuento'
      Origin = '"Detalles_Factura"."Descuento"'
    end
    object tMercancia_ClienteValor_Impuesto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Impuesto'
      Origin = '"Detalles_Factura"."Valor_Impuesto"'
      currency = True
    end
    object tMercancia_ClienteValor_Descuento: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Valor_Descuento'
      Origin = '"Detalles_Factura"."Valor_Descuento"'
      currency = True
    end
    object tMercancia_ClienteTotal_Impuesto: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Impuesto'
      Origin = '"Detalles_Factura"."Total_Impuesto"'
      currency = True
    end
    object tMercancia_ClienteTotal_Descuento: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Total_Descuento'
      Origin = '"Detalles_Factura"."Total_Descuento"'
      currency = True
    ...
    object tMercancia_ClienteUnidades: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Unidades'
      Origin = '"Detalles_Factura"."Unidades"'
      Precision = 12
    ...
    object tMercancia_ClientePrecio_Unidad: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'Precio_Unidad'
      Origin = '"Detalles_Factura"."Precio_Unidad"'
      currency = True
    end
    object tMercancia_ClienteMedida: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Medida'
      Origin = '"Detalles_Factura"."Medida"'
      Size = 25
    end
    object tMercancia_ClienteUsuario_Autorizacion: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Usuario_Autorizacion'
      Origin = '"Detalles_Factura"."Usuario_Autorizacion"'
      Size = 100
    end
    object tMercancia_ClienteProc_Detalle: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Proc_Detalle'
      Origin = '"Detalles_Factura"."Proc_Detalle"'
      Size = 25
    end
    object tMercancia_ClienteID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
      Origin = '"Detalles_Factura"."ID"'
      Size = 50
  ...
  object tSeriales_Vendida_Cliente: TClientDataSet
    ...
    object tSeriales_Vendida_ClienteProc_Detalle: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Proc_Detalle'
      Size = 25
    end
    object tSeriales_Vendida_ClienteID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
      Size = 50
    end
  ...
  object tMercancia_Desp_Cliente: TClientDataSet
    ...
    object tMercancia_Desp_ClientePrecio: TBCDField
      FieldName = 'Precio'
      Origin = '"Detalles_Salida"."Precio"'
      Precision = 12
      Size = 2
    end
    object tMercancia_Desp_ClienteID: TStringField
      FieldName = 'ID'
      Origin = '"Detalles_Salida"."ID"'
      Size = 50
    end
  ...
  object tSeriales_Desp_Cliente: TClientDataSet
    ...
    object tSeriales_Desp_ClienteProc_Detalle: TStringField
      FieldName = 'Proc_Detalle'
      Size = 25
    end
    object tSeriales_Desp_ClienteID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  ...
  object tSalidas_Cliente: TClientDataSet
    ...
    object tSalidas_ClienteID: TStringField
      FieldName = 'ID'
      Origin = '"Salidas_Inventario"."ID"'
      Size = 50
    end
  ...
  object tTerminal: TClientDataSet
    Aggregates = <>
    ConnectionBroker = Concentrador
    Params = <
      item
    ...
    ProviderName = 'prTerminal'
    BeforeRefresh = ChkRefresh
    OnCalcFields = tProductosCalcFields
    OnReconcileError = DataSetReconcileError
    Left = 644
    Top = 598
    object tTerminalID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
      Size = 50
    end
    object tTerminalDescripcion: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Descripcion'
      Size = 100
    end
    object tTerminalStatus: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Status'
      Size = 50
    end
    object tTerminalHora_Apertura: TTimeField
      AutoGenerateValue = arDefault
      FieldName = 'Hora_Apertura'
    end
    object tTerminalHora_Cierre: TTimeField
      AutoGenerateValue = arDefault
      FieldName = 'Hora_Cierre'
    end
    object tTerminalNombre: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Nombre'
      Size = 100
    end
    object tTerminalNombre_2: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Nombre_2'
      Size = 100
    end
    object tTerminalNombre_3: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Nombre_3'
      Size = 100
    end
    object tTerminalDireccion: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Direccion'
      Size = 100
    end
    object tTerminalDireccion_2: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Direccion_2'
      Size = 100
    end
    object tTerminalCiudad: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Ciudad'
      Size = 100
    end
    object tTerminalPais: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Pais'
      Size = 100
    end
    object tTerminalTelefono: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Telefono'
    end
    object tTerminalImpresora: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Impresora'
    end
    object tTerminalPuerto: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Puerto'
    end
    object tTerminalFormato_Numeros: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Formato_Numeros'
    end
    object tTerminalComentario_1: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Comentario_1'
      Size = 100
    end
    object tTerminalComentario_2: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Comentario_2'
      Size = 100
    end
    object tTerminalComentario_3: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Comentario_3'
      Size = 100
    end
    object tTerminalComentario_4: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Comentario_4'
      Size = 100
    end
    object tTerminalSeparador_Linea: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Separador_Linea'
      FixedChar = True
      Size = 1
    end
    object tTerminalSimbolo_Moneda: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Simbolo_Moneda'
      Size = 6
    end
    object tTerminalFormato_Fecha: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Formato_Fecha'
      Size = 100
    end
    object tTerminalFormato_Hora: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Formato_Hora'
      Size = 100
    end
    object tTerminalFormato_Fecha_Largo: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Formato_Fecha_Largo'
      Size = 100
    end
    object tTerminalFormato_Hora_Largo: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Formato_Hora_Largo'
      Size = 100
    end
    object tTerminalFormato_N_T_H: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Formato_N_T_H'
      Size = 100
    end
    object tTerminalCtrl_Alt_Del: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Ctrl_Alt_Del'
    end
    object tTerminalAlt_F4: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Alt_F4'
    end
    object tTerminalBarra: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Barra'
    end
    object tTerminalPanel: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Panel'
    end
    object tTerminalRun: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Run'
    end
    object tTerminalFind: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Find'
    end
    object tTerminalWinKey: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'WinKey'
    end
    object tTerminalColor_Pantallas: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'Color_Pantallas'
    end
    object tTerminalApagar_Salir: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Apagar_Salir'
    end
    object tTerminalLineas_Despues: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'Lineas_Despues'
    end
    object tTerminalAncho_Linea: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'Ancho_Linea'
    end
    object tTerminalDireccion_Local: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Direccion_Local'
      Size = 100
    end
    object tTerminalIcon: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'Icon'
    end
    object tTerminalBalance: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Balance'
      Precision = 12
      Size = 2
    end
    object tTerminalUltima_Cta: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'Ultima_Cta'
    end
    object tTerminalFecha_Ultima_Cta: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'Fecha_Ultima_Cta'
    end
    object tTerminalRNC: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'RNC'
      Size = 50
    end
    object tTerminalNombre_Impuesto: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Nombre_Impuesto'
      Size = 25
    end
    object tTerminalCondicion_Facturas: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Condicion_Facturas'
      Size = 25
    end
    object tTerminalTipo_Factura: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Tipo_Factura'
      Size = 25
    end
    object tTerminalTermino_Facturacion: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Termino_Facturacion'
      Size = 25
    end
    object tTerminalInventario_Restringido: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Inventario_Restringido'
    end
    object tTerminalAperturar_Caja: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'Aperturar_Caja'
    end
    object tTerminalDecimales_Cantidades: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Decimales_Cantidades'
      Size = 25
    end
    object tTerminalAlmacen: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Almacen'
      Size = 25
    end
  end
  object dTerminal: TDataSource
    DataSet = tTerminal
    Left = 752
    Top = 627
  end
  object tTerminales: TClientDataSet
    ...
    object tTerminalesBalance: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Balance'
      Precision = 12
      Size = 2
  ...
  object tInventario_Terminal: TClientDataSet
    Aggregates = <>
    ConnectionBroker = Concentrador
    Params = <
      item
    ...
    ProviderName = 'prInventario_Terminal'
    BeforeRefresh = ChkRefresh
    OnCalcFields = tProductosCalcFields
    OnReconcileError = DataSetReconcileError
    Left = 648
    Top = 731
    object tInventario_TerminalCodigo_Producto: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Codigo_Producto'
      Size = 25
    end
    object tInventario_TerminalCodigo_Almacen: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Codigo_Almacen'
      Size = 25
    end
    object tInventario_TerminalUnidades_Compradas: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Unidades_Compradas'
      Precision = 12
      Size = 2
    end
    object tInventario_TerminalUnidades_Facturadas: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Unidades_Facturadas'
      Precision = 12
      Size = 2
    end
    object tInventario_TerminalUnidades_Despachadas: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Unidades_Despachadas'
      Precision = 12
      Size = 2
    end
    object tInventario_TerminalUnidades_Devueltas_Compras: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Unidades_Devueltas_Compras'
      Precision = 12
      Size = 2
    end
    object tInventario_TerminalUnidades_Devueltas_Facturas: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Unidades_Devueltas_Facturas'
      Precision = 12
      Size = 2
    end
    object tInventario_TerminalExistencia: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'Existencia'
      Precision = 12
      Size = 2
    end
    object tInventario_TerminalID: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
      Size = 50
    end
  end
  object dInventario_Terminal: TDataSource
    DataSet = tInventario_Terminal
    Left = 752
    Top = 731
  end
end
