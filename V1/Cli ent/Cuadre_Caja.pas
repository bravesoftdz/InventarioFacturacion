...
uses
  ...
  raCodMod, ppVar, Db, Menus, ActnColorMaps, ToolWin, ActnCtrls;
...
uses DataModulo, Utilidades, dotmatrx, User_Login, Apertura_Caja, MainForm;
...
begin
  ...
  FMainMenu.Main_Status_Bar.Panels.PanelByName('Usuarios').Text := _CurrentUser;
  FMainMenu.Main_Status_Bar.Panels.PanelByName('Terminales').Text := _CurrentTerminal;
...
begin
  ...
  Try
    ...
    Modulo.tDenominaciones_Moneda.First;
    Modulo.tDetalle_Cuadre.BeforePost := Nil;
    While Not Modulo.tDenominaciones_Moneda.Eof Do
      Begin
        If Not Modulo.tDetalle_Cuadre.Locate(Modulo.tDetalle_CuadreMoneda.FieldName+';'+Modulo.tDetalle_CuadreDenominacion.FieldName,
                                             VarArrayOf([Modulo.tDenominaciones_MonedaMoneda.Value,Modulo.tDenominaciones_MonedaDenominacion.Value]),
                                             []) Then
          Modulo.tDetalle_Cuadre.Append
        Else
          Modulo.tDetalle_Cuadre.Edit;

        Modulo.tDetalle_CuadreMoneda.Value := Modulo.tDenominaciones_MonedaMoneda.Value;
        Modulo.tDetalle_CuadreDenominacion.Value := Modulo.tDenominaciones_MonedaDenominacion.Value;
        Modulo.tDetalle_Cuadre.Post;
        Modulo.tDenominaciones_Moneda.Next
      End
  Finally
//    Modulo.tDetalle_Cuadre.BeforePost := Modulo.tDetalle_CuadreBeforePost;
    ...
    Modulo.tReporter.CommandText := Format(_SelectVenta_Usuario_Fecha,
                                           [QuotedStr(Trim(_CurrentUser)),
                                           QuotedStr(FormatDateTime('mm/dd/yyyy',Date())),
                                           QuotedStr(_stACTIVO)]);
