...
begin
  ...
  If Count < 8 Then
    Begin
      Modulo.tDetalles_AcuerdosCodigo.Value := Buffer;
      Buffer := ''
    End
end;
...
begin
    Try
      ...
      DlgSearch.OpenDlg('Acuerdos_Trabajo',Modulo.tAcuerdosNumero.FieldName,'D',wsMaximized);
      If DlgSearch.ModalResult = MrOk Then
        Begin
          ...
          Modulo.tAcuerdos.Cancel;
          Modulo.tAcuerdos.CancelUpdates;
          Modulo.tAcuerdos.Params.ParamByName('Proceso').AsString := DlgSearch.SrchCds.FieldByName('Proceso').AsString;
          Modulo.tAcuerdos.Refresh;
