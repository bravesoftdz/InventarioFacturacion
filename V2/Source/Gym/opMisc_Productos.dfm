object FOpciones_Misc_Productos: TFOpciones_Misc_Productos
  Left = 0
  Top = 0
  ...
  object Label5: TLabel
    ...
    Width = 100
    Height = 13
    Caption = 'Formato Descripci'#243'n '
  end
  object GroupBox1: TGroupBox
    ...
    Width = 327
    Height = 115
    Caption = '] Etiquetas para Renglones de Precios ['
    TabOrder = 0
