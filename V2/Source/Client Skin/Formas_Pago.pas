...
type
  TFMetodos = class(TForm)
    ...
    procedure EsEfectivoClick(Sender: TObject);
  private
...
begin
  S := DoSearch(Nil,
                'Formas_Pago',                                          (* TableName *)
                'SrchPr',                                         (* Provider *)
                Modulo.tFormas_PagoNumero.FieldName, (* CampoClave *)
                Modulo.tFormas_PagoDescripcion.FieldName,      (* CampoInicial *)
                '',      (* AltQry *)
...
procedure TFMetodos.EsEfectivoClick(Sender: TObject);
begin
  Detalles.Enabled := EsEfectivo.Checked;
end;
