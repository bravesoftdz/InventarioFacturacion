...
begin
  ...
  If Diferencias < 0 Then
    Begin
      Mensaje ('BALANCE MENOR AL ACTUAL'#13#13'Para lograr este balance, haga un abono a la cuenta '#13'mediante la opcion de CUENTAS POR COBRAR en el menu principal');
      Exit;
    End;
