...
uses DataModulo, Utilidades, SrchDlg, Terminos, Generales, Paises;
...
procedure TFProveedores.PaisChange(Sender: TObject);
begin
...
begin
  ...
  FOTOLoadAndDisplay(Modulo.tProveedoresFoto,FOTO,_DefaultImgDir + _DefaultClientImg)
end;
