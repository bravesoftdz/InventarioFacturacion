...
begin
  ...
  If (_CurrentLevel <> _SysAdmin) And (Trim(ModuloGenerales.tUsuariosNivel_Acceso.Value) = _SysAdmin) Then Exit;
...
begin
    Try
      ...
      DlgSearch.OpenDlg('Usuarios',ModuloGenerales.tUsuariosNombreCompleto.FieldName,'A',wsNormal);
      If DlgSearch.ModalResult = MrOk Then
        Begin
           Nombre_Usuario.Text := DlgSearch.SrchCds.FieldByName('NickName').AsString;
