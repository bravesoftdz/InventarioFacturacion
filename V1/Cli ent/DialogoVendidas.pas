...
uses
  ...
  Mask, wwdbedit, Wwdotdot, db, Wwdbcomb;
...
begin
  ...
  Case Usuarios.ItemIndex Of
    ...
    1 : Begin
          CriterioUsuario := 'AND "Usuario" = ' + QuotedStr(Trim(Modulo.tListadoUsuariosNickName.AsString));
          SeleccionUsuario := Modulo.tListadoUsuariosNombreCompleto.AsString;
        End;
  End; {Case Status}
