...
var
  FAccountConfig: TFAccountConfig;
...
procedure TFAccountConfig.BitBtn2Click(Sender: TObject);
begin
  Close;
end;

procedure TFAccountConfig.BitBtn1Click(Sender: TObject);
begin
  {Conexion}
  RegInfo.CloseKey;
  RegInfo.OpenKey(_Acc_DataRouteKey,True);
...
procedure TFAccountConfig.FormCreate(Sender: TObject);
begin
...
procedure TFAccountConfig.FormKeyPress(Sender: TObject; var Key: Char);
 Var
  Found : TWinControl;
begin
