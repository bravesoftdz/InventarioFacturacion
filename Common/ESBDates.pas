...
{: ESB Date/Time Routines Collection v 2.1.0

	Date/Time Routines to enhance your 32-bit Delphi
	Programming. <p>

	(c)1999-2000 ESB Consultancy <p>
	...
	Check out the website at http://www.esbpcs.com/<p>
...
function AddFortnights (const DT: TDateTime; const FNights: Extended): TDateTime;
begin
	Result := AddWeeks (DT, FNights * 2) + FNights;
end;
...
begin
	try
		...
		Result := EncodeDate (Year, Month, Day) + Frac (Str2Time (sTime));
	except
		result := 0;
	end;
end;
