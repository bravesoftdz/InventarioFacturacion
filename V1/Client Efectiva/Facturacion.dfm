    ...
    object Pg_Detalles_Factura: TAdvTabSheet
      ...
      object Descripciones: TwwDBLookupCombo
        ...
        Selected.Strings = (
          ...
          'Presentacion'#9'10'#9'Presentacion'#9'F'
      ...
      object Tipos_Precios: TwwDBComboBox
        ...
        ItemHeight = 0
        Items.Strings = (
          'Caliente - 1'#9'Por Mayor Cr'#233'dito'
          'Caliente - 2'#9'Por Mayor Contado'
          'Fria - 1'#9'Detalle Cr'#233'dito'
          'Fria - 2'#9'Detalle Contado')
        ItemIndex = 0
        Sorted = False
        TabOrder = 3
  ...
  object Panel_Datos_Factura: TAdvPageControl
    ...
    object Pg_Datos_Factura: TAdvTabSheet
      ...
      object Tipo_Factura: TwwCheckBox
        ...
        DisplayValueChecked = 'Fria'
        DisplayValueUnchecked = 'Caliente'
